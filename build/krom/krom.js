...
Project.prototype = {
	...
	,render: function(frames) {
		if(frames.length > 0) {
			...
			graphics.set_fontSize(22);
			Text.drawText(graphics,"This is<nl>cool text<nl>I love it",new kha_math_Vector2(this.windowWidth,this.windowHeight),12,12,OriginPoint.bottomRight);
