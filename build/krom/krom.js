...
kha_Shaders.init = function() {
	...
	var blobs1 = [];
	var data1 = Reflect.field(kha_Shaders,"painter_image_vertData" + 0);
	var bytes1 = haxe_Unserializer.run(data1);
	blobs1.push(kha_internal_BytesBlob.fromBytes(bytes1));
	kha_Shaders.painter_image_vert = new kha_graphics4_VertexShader(blobs1,["painter-image.vert.d3d11"]);
	var blobs2 = [];
	...
	kha_Shaders.painter_colored_vert = new kha_graphics4_VertexShader(blobs3,["painter-colored.vert.d3d11"]);
	var blobs4 = [];
