...
Project.prototype = {
	...
	,init: function() {
		...
		this.masterDivision.addChild(new components_DivisionRect(new kha_math_Vector2(100,100),100,200));
	}
	,update: function() {
	}
...
kha_Shaders.init = function() {
	...
	var blobs2 = [];
	var data2 = Reflect.field(kha_Shaders,"painter_image_vertData" + 0);
	...
	kha_Shaders.painter_image_frag = new kha_graphics4_FragmentShader(blobs3,["painter-image.frag.d3d11"]);
	var blobs4 = [];
	var data4 = Reflect.field(kha_Shaders,"painter_text_vertData" + 0);
	...
	var blobs5 = [];
	var data5 = Reflect.field(kha_Shaders,"painter_video_fragData" + 0);
	var bytes5 = haxe_Unserializer.run(data5);
	blobs5.push(kha_internal_BytesBlob.fromBytes(bytes5));
	kha_Shaders.painter_video_frag = new kha_graphics4_FragmentShader(blobs5,["painter-video.frag.d3d11"]);
	var blobs6 = [];
	...
	kha_Shaders.painter_text_frag = new kha_graphics4_FragmentShader(blobs6,["painter-text.frag.d3d11"]);
	var blobs7 = [];
