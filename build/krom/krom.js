...
components_DivisionRect.prototype = {
	...
	,getSize: function() {
		return new kha_math_Vector2(this.width,this.height);
	}
	,isOver: function(x,y) {
		return null;
	}
...
kha_Shaders.init = function() {
	...
	var blobs1 = [];
	var data1 = Reflect.field(kha_Shaders,"painter_image_fragData" + 0);
	var bytes1 = haxe_Unserializer.run(data1);
	blobs1.push(kha_internal_BytesBlob.fromBytes(bytes1));
	kha_Shaders.painter_image_frag = new kha_graphics4_FragmentShader(blobs1,["painter-image.frag.d3d11"]);
	var blobs2 = [];
	...
	kha_Shaders.painter_colored_vert = new kha_graphics4_VertexShader(blobs2,["painter-colored.vert.d3d11"]);
	var blobs3 = [];
	var data3 = Reflect.field(kha_Shaders,"painter_text_vertData" + 0);
	var bytes3 = haxe_Unserializer.run(data3);
	blobs3.push(kha_internal_BytesBlob.fromBytes(bytes3));
	kha_Shaders.painter_text_vert = new kha_graphics4_VertexShader(blobs3,["painter-text.vert.d3d11"]);
	var blobs4 = [];
	var data4 = Reflect.field(kha_Shaders,"painter_video_fragData" + 0);
	var bytes4 = haxe_Unserializer.run(data4);
	blobs4.push(kha_internal_BytesBlob.fromBytes(bytes4));
	kha_Shaders.painter_video_frag = new kha_graphics4_FragmentShader(blobs4,["painter-video.frag.d3d11"]);
	var blobs5 = [];
	var data5 = Reflect.field(kha_Shaders,"painter_image_vertData" + 0);
	var bytes5 = haxe_Unserializer.run(data5);
	blobs5.push(kha_internal_BytesBlob.fromBytes(bytes5));
	kha_Shaders.painter_image_vert = new kha_graphics4_VertexShader(blobs5,["painter-image.vert.d3d11"]);
	var blobs6 = [];
	...
	var blobs7 = [];
	var data7 = Reflect.field(kha_Shaders,"painter_text_fragData" + 0);
	var bytes7 = haxe_Unserializer.run(data7);
	blobs7.push(kha_internal_BytesBlob.fromBytes(bytes7));
	kha_Shaders.painter_text_frag = new kha_graphics4_FragmentShader(blobs7,["painter-text.frag.d3d11"]);
};
