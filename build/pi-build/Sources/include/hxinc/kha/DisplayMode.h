...
class HXCPP_CLASS_ATTRIBUTES DisplayMode_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< DisplayMode_obj > __new(int width,int height,int frequency,int bitsPerPixel) {
			hx::ObjectPtr< DisplayMode_obj > __this = new DisplayMode_obj();
			__this->__construct(width,height,frequency,bitsPerPixel);
			return __this;
		}

		static hx::ObjectPtr< DisplayMode_obj > __alloc(hx::Ctx *_hx_ctx,int width,int height,int frequency,int bitsPerPixel) {
