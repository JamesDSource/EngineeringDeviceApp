...
class HXCPP_CLASS_ATTRIBUTES VertexElement_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< VertexElement_obj > __new(::String name,int data) {
			hx::ObjectPtr< VertexElement_obj > __this = new VertexElement_obj();
			__this->__construct(name,data);
			return __this;
		}

		static hx::ObjectPtr< VertexElement_obj > __alloc(hx::Ctx *_hx_ctx,::String name,int data) {
...
HXLINE(   8)		( ( ::kha::graphics4::VertexElement)(__this) )->name = name;
