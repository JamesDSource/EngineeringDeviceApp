...
class BlendingOperation_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_("kha.graphics4.BlendingOperation",a7,d4,66,ad); }
		::String __ToString() const { return HX_("BlendingOperation.",d8,7a,09,e7) + _hx_tag; }
