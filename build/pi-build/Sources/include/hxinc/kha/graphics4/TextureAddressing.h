...
class TextureAddressing_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_("kha.graphics4.TextureAddressing",5a,bc,8b,d3); }
		::String __ToString() const { return HX_("TextureAddressing.",c5,4f,2f,21) + _hx_tag; }
