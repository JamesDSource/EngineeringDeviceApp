...
class HXCPP_CLASS_ATTRIBUTES Entity_obj {
	public:
		...
		static inline int _id( ::Dynamic _hx_) {
			return (_hx_.mPtr->*( static_cast< ::kha::netsync::Entity_obj *>(_hx_.mPtr->_hx_getInterface(0x4b942fd7)))->_hx__id)();
		}
		int (hx::Object :: *_hx__size)(); 
		static inline int _size( ::Dynamic _hx_) {
			return (_hx_.mPtr->*( static_cast< ::kha::netsync::Entity_obj *>(_hx_.mPtr->_hx_getInterface(0x4b942fd7)))->_hx__size)();
		}
		...
		static inline int _send( ::Dynamic _hx_,int offset, ::haxe::io::Bytes bytes) {
			return (_hx_.mPtr->*( static_cast< ::kha::netsync::Entity_obj *>(_hx_.mPtr->_hx_getInterface(0x4b942fd7)))->_hx__send)(offset,bytes);
		}
		...
		static inline int _receive( ::Dynamic _hx_,int offset, ::haxe::io::Bytes bytes) {
			return (_hx_.mPtr->*( static_cast< ::kha::netsync::Entity_obj *>(_hx_.mPtr->_hx_getInterface(0x4b942fd7)))->_hx__receive)(offset,bytes);
		}
};
