...
class HXCPP_CLASS_ATTRIBUTES Client_obj {
	public:
		...
		static inline int get_id( ::Dynamic _hx_) {
			return (_hx_.mPtr->*( static_cast< ::kha::netsync::Client_obj *>(_hx_.mPtr->_hx_getInterface(0x50c7e6ff)))->_hx_get_id)();
		}
		...
		static inline void send( ::Dynamic _hx_, ::haxe::io::Bytes bytes,bool mandatory) {
			(_hx_.mPtr->*( static_cast< ::kha::netsync::Client_obj *>(_hx_.mPtr->_hx_getInterface(0x50c7e6ff)))->_hx_send)(bytes,mandatory);
		}
		void (hx::Object :: *_hx_receive)( ::Dynamic receiver); 
		static inline void receive( ::Dynamic _hx_, ::Dynamic receiver) {
			(_hx_.mPtr->*( static_cast< ::kha::netsync::Client_obj *>(_hx_.mPtr->_hx_getInterface(0x50c7e6ff)))->_hx_receive)(receiver);
		}
		void (hx::Object :: *_hx_onClose)( ::Dynamic close); 
		static inline void onClose( ::Dynamic _hx_, ::Dynamic close) {
			(_hx_.mPtr->*( static_cast< ::kha::netsync::Client_obj *>(_hx_.mPtr->_hx_getInterface(0x50c7e6ff)))->_hx_onClose)(close);
		}
};
