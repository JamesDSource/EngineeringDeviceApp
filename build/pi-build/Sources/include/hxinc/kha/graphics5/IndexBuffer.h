...
#define INCLUDED_kha_graphics5_IndexBuffer
...
class HXCPP_CLASS_ATTRIBUTES IndexBuffer_obj : public hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x6ef9daa4 };

		void __construct(int indexCount, ::kha::graphics4::Usage usage,hx::Null< bool >  __o_canRead);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="kha.graphics5.IndexBuffer")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"kha.graphics5.IndexBuffer"); }
...
Kore::Graphics5::IndexBuffer* buffer;
};

} // end namespace kha
} // end namespace graphics5

#endif /* INCLUDED_kha_graphics5_IndexBuffer */ 
