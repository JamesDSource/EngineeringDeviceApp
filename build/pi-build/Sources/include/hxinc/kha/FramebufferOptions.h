...
class HXCPP_CLASS_ATTRIBUTES FramebufferOptions_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< FramebufferOptions_obj > __new( ::Dynamic __o_frequency, ::Dynamic __o_verticalSync, ::Dynamic __o_colorBufferBits, ::Dynamic __o_depthBufferBits, ::Dynamic __o_stencilBufferBits, ::Dynamic __o_samplesPerPixel) {
		...
		static hx::ObjectPtr< FramebufferOptions_obj > __alloc(hx::Ctx *_hx_ctx, ::Dynamic __o_frequency, ::Dynamic __o_verticalSync, ::Dynamic __o_colorBufferBits, ::Dynamic __o_depthBufferBits, ::Dynamic __o_stencilBufferBits, ::Dynamic __o_samplesPerPixel) {
