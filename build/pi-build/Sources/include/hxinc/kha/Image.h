...
class HXCPP_CLASS_ATTRIBUTES Image_obj : public hx::Object
{
	...
	public:
		...
		static  ::kha::Image _create2(int width,int height, ::kha::graphics4::TextureFormat format,bool readable,bool renderTarget,int depthStencil,bool antiAliasing,int contextId);
		static ::Dynamic _create2_dyn();

		static  ::kha::Image _create3(int width,int height,int depth, ::kha::graphics4::TextureFormat format,bool readable,int contextId);
