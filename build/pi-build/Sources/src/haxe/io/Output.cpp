...
HXLINE( 227)			this->writeByte(((x >> 8) & 255));
HXLINE( 228)			this->writeByte((x & 255));
            		}
            		else {
HXLINE( 230)			this->writeByte((x & 255));
HXLINE( 231)			this->writeByte(((x >> 8) & 255));
HXLINE( 232)			this->writeByte(((x >> 16) & 255));
HXLINE( 233)			this->writeByte(hx::UShr(x,24));
            		}
            	}
