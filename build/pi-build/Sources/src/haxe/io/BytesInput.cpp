...
HXLINE(  40)			len = (b->length - ( (int)(pos) ));
            		}
HXLINE(  41)		bool _hx_tmp;
HXDLIN(  41)		bool _hx_tmp1;
HXDLIN(  41)		if (hx::IsGreaterEq( pos,0 )) {
HXLINE(  41)			_hx_tmp1 = hx::IsLess( len,0 );
            		}
            		else {
...
HXLINE(  54)		this->pos = ( (int)(pos) );
HXLINE(  55)		this->len = ( (int)(len) );
HXLINE(  56)		this->totlen = ( (int)(len) );
            	}
...
HXLINE(  96)		this->len--;
HXLINE( 100)		return ( (int)(this->b->__get(this->pos++)) );
            	}
...
HXDLIN( 111)		if ((pos >= 0)) {
HXLINE( 111)			_hx_tmp1 = (len < 0);
            		}
            		else {
HXLINE( 111)			_hx_tmp1 = true;
            		}
HXDLIN( 111)		if (!(_hx_tmp1)) {
HXLINE( 111)			_hx_tmp = ((pos + len) > buf->length);
            		}
            		else {
HXLINE( 111)			_hx_tmp = true;
            		}
HXDLIN( 111)		if (_hx_tmp) {
HXLINE( 112)			HX_STACK_DO_THROW(::haxe::io::Error_obj::OutsideBounds_dyn());
            		}
HXLINE( 135)		bool _hx_tmp2;
HXDLIN( 135)		if ((this->len == 0)) {
HXLINE( 135)			_hx_tmp2 = (len > 0);
            		}
            		else {
HXLINE( 135)			_hx_tmp2 = false;
            		}
HXDLIN( 135)		if (_hx_tmp2) {
HXLINE( 136)			HX_STACK_DO_THROW( ::haxe::io::Eof_obj::__alloc( HX_CTX ));
            		}
HXLINE( 137)		if ((this->len < len)) {
HXLINE( 138)			len = this->len;
            		}
HXLINE( 144)		::Array< unsigned char > b1 = this->b;
HXLINE( 145)		::Array< unsigned char > b2 = buf->b;
HXLINE( 146)		{
HXLINE( 146)			int _g = 0;
HXDLIN( 146)			int _g1 = len;
HXDLIN( 146)			while((_g < _g1)){
HXLINE( 146)				_g = (_g + 1);
HXDLIN( 146)				int i = (_g - 1);
HXLINE( 147)				b2[(pos + i)] = b1->__get((this->pos + i));
            			}
            		}
HXLINE( 149)		 ::haxe::io::BytesInput _hx_tmp3 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 149)		_hx_tmp3->pos = (_hx_tmp3->pos + len);
HXLINE( 150)		 ::haxe::io::BytesInput _hx_tmp4 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 150)		_hx_tmp4->len = (_hx_tmp4->len - len);
HXLINE( 152)		return len;
            	}
