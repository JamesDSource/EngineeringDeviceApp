...
HXLINE(  67)			me->run();
            	...
            	HX_STACKFRAME(&_hx_pos_102f69689d37b2bb_57_new)
HXLINE(  58)		 ::haxe::Timer me = hx::ObjectPtr<OBJ_>(this);
HXLINE(  67)		this->id = ::kha::Scheduler_obj::addTimeTask( ::Dynamic(new _hx_Closure_0(me)),(( (Float)(time_ms) ) / ( (Float)(1000) )),(( (Float)(time_ms) ) / ( (Float)(1000) )),null());
            	}
...
HXLINE( 119)		t->run =  ::Dynamic(new _hx_Closure_0(f,t));
HXLINE( 123)		return t;
            	}
