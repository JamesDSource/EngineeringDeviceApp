...
HXLINE(  41)			 ::Date _hx_tmp = ::Date_obj::fromTime(( (Float)(0) ));
HXDLIN(  41)			 ::Date _hx_tmp1 = ::Date_obj::fromTime(( (Float)(0) ));
...
HXLINE(  42)		s2->__SetField(HX_("atime",ee,10,db,26),::Date_obj::fromTime((((Float)1000.0) * ( (Float)(s2->__Field(HX_("atime",ee,10,db,26),hx::paccDynamic)) ))),hx::paccDynamic);
HXLINE(  43)		s2->__SetField(HX_("mtime",fa,06,aa,0f),::Date_obj::fromTime((((Float)1000.0) * ( (Float)(s2->__Field(HX_("mtime",fa,06,aa,0f),hx::paccDynamic)) ))),hx::paccDynamic);
HXLINE(  44)		s2->__SetField(HX_("ctime",f0,39,a8,4d),::Date_obj::fromTime((((Float)1000.0) * ( (Float)(s2->__Field(HX_("ctime",f0,39,a8,4d),hx::paccDynamic)) ))),hx::paccDynamic);
HXLINE(  45)		return s2;
            	}
