...
HXLINE( 284)		this->vb =  ::kha::graphics4::VertexBuffer_obj::__alloc( HX_CTX ,4,structure,::kha::graphics4::Usage_obj::StaticUsage_dyn(),null(),null());
...
HXLINE( 294)		this->ib =  ::kha::graphics4::IndexBuffer_obj::__alloc( HX_CTX ,6,::kha::graphics4::Usage_obj::StaticUsage_dyn(),null());
