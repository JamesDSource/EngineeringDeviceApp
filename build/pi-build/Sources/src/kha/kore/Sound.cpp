...
HXLINE(  42)				::haxe::Log_obj::trace((HX_("Unknown sound format: ",04,53,85,0f) + filename),hx::SourceInfo(HX_("kha/kore/Sound.hx",fc,c0,12,70),42,HX_("kha.kore.Sound",62,87,c4,f4),HX_("new",60,d0,53,00)));
            			}
            		}
            	}
...
static ::String Sound_obj_sMemberFields[] = {
	HX_("initWav",fc,67,91,cb),
	HX_("initOgg",1f,5b,8b,cb),
	HX_("_createData",65,e4,7a,27),
	::String(null()) };
...
void Sound_obj::__register()
{
	...
	__mClass->mName = HX_("kha.kore.Sound",62,87,c4,f4);
