...
void Window_obj::__construct(int num, ::kha::WindowOptions win){
            	HX_STACKFRAME(&_hx_pos_ae07b069c940886a_60_new)
...
HXDLIN(  63)		this->windowTitle = _hx_tmp1;
HXLINE(  64)		::kha::Window_obj::resizeCallbacks[num] = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  65)		::kha::Window_obj::ppiCallbacks[num] = ::Array_obj< ::Dynamic>::__new(0);
            	}
...
bool Window_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x7fe2ed10;
}
...
::String Window_obj::set_title(::String value){
            	HX_STACKFRAME(&_hx_pos_ae07b069c940886a_217_set_title)
            	Kore::Window::get(this->num)->setTitle(value.c_str());

HXLINE( 218)		this->windowTitle = value;
...
HXLINE(  84)			_hx_tmp =  ::kha::WindowOptions_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null(),null());
            		}
            		else {
...
HXLINE(  84)			_hx_tmp1 =  ::kha::FramebufferOptions_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
            		}
            		else {
...
hx::Val Window_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"windowTitle") ) { windowTitle=inValue.Cast< ::String >(); return inValue; }
	}
