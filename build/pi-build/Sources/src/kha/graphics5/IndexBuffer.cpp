...
HX_DEFINE_STACK_FRAME(_hx_pos_d1b5227c0c6aa106_15_new,"kha.graphics5.IndexBuffer","new",0xafee9756,"kha.graphics5.IndexBuffer.new","kha/graphics5/IndexBuffer.hx",15,0x7578ff9c)
HX_LOCAL_STACK_FRAME(_hx_pos_d1b5227c0c6aa106_22_delete,"kha.graphics5.IndexBuffer","delete",0x7a5836f5,"kha.graphics5.IndexBuffer.delete","kha/graphics5/IndexBuffer.hx",22,0x7578ff9c)
HX_LOCAL_STACK_FRAME(_hx_pos_d1b5227c0c6aa106_31_lock2,"kha.graphics5.IndexBuffer","lock2",0x5a03c25d,"kha.graphics5.IndexBuffer.lock2","kha/graphics5/IndexBuffer.hx",31,0x7578ff9c)
HX_LOCAL_STACK_FRAME(_hx_pos_d1b5227c0c6aa106_34_lock,"kha.graphics5.IndexBuffer","lock",0x3f8aec35,"kha.graphics5.IndexBuffer.lock","kha/graphics5/IndexBuffer.hx",34,0x7578ff9c)
HX_LOCAL_STACK_FRAME(_hx_pos_d1b5227c0c6aa106_41_unlock,"kha.graphics5.IndexBuffer","unlock",0x750c198e,"kha.graphics5.IndexBuffer.unlock","kha/graphics5/IndexBuffer.hx",41,0x7578ff9c)
HX_LOCAL_STACK_FRAME(_hx_pos_d1b5227c0c6aa106_46_count,"kha.graphics5.IndexBuffer","count",0x2b763545,"kha.graphics5.IndexBuffer.count","kha/graphics5/IndexBuffer.hx",46,0x7578ff9c)
namespace kha{
namespace graphics5{
...
void IndexBuffer_obj::__construct(int indexCount, ::kha::graphics4::Usage usage,hx::Null< bool >  __o_canRead){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_d1b5227c0c6aa106_15_new)
...
HXLINE(  18)		buffer = new Kore::Graphics5::IndexBuffer(indexCount, true);;
            	}
...
bool IndexBuffer_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x6ef9daa4;
}

void IndexBuffer_obj::_hx_delete(){
            	HX_STACKFRAME(&_hx_pos_d1b5227c0c6aa106_22_delete)
...
HX_DEFINE_DYNAMIC_FUNC0(IndexBuffer_obj,_hx_delete,(void))
 ...
 ::kha::arrays::Uint32ArrayPrivate IndexBuffer_obj::lock2(int start,int count){
            	HX_STACKFRAME(&_hx_pos_d1b5227c0c6aa106_31_lock2)
...
HX_DEFINE_DYNAMIC_FUNC2(IndexBuffer_obj,lock2,return )
 ...
 ::kha::arrays::Uint32ArrayPrivate IndexBuffer_obj::lock( ::Dynamic start, ::Dynamic count){
            	HX_STACKFRAME(&_hx_pos_d1b5227c0c6aa106_34_lock)
...
HXLINE(  37)		return this->lock2(( (int)(start) ),( (int)(count) ));
            	}
...
void IndexBuffer_obj::unlock(){
            	HX_STACKFRAME(&_hx_pos_d1b5227c0c6aa106_41_unlock)
            	buffer->unlock();
...
int IndexBuffer_obj::count(){
            	HX_STACKFRAME(&_hx_pos_d1b5227c0c6aa106_46_count)
...
hx::ObjectPtr< IndexBuffer_obj > IndexBuffer_obj::__alloc(hx::Ctx *_hx_ctx,int indexCount, ::kha::graphics4::Usage usage,hx::Null< bool >  __o_canRead) {
	IndexBuffer_obj *__this = (IndexBuffer_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(IndexBuffer_obj), true, "kha.graphics5.IndexBuffer"));
...
void IndexBuffer_obj::__register()
{
	...
	__mClass->mName = HX_("kha.graphics5.IndexBuffer",64,f4,96,34);
