...
static hx::StorageInfo Worker_obj_sMemberStorageInfo[] = {
	{hx::fsObject /*  ::cpp::vm::Thread */ ,(int)offsetof(Worker_obj,thread),HX_("thread",ca,7a,b9,8e)},
	{ hx::fsUnknown, 0, null()}
};
static hx::StaticInfo Worker_obj_sStaticStorageInfo[] = {
	{hx::fsObject /*  ::cpp::vm::Thread */ ,(void *) &Worker_obj::_mainThread,HX_("_mainThread",02,65,ef,b6)},
	{ hx::fsUnknown, 0, null()}
};
#endif
