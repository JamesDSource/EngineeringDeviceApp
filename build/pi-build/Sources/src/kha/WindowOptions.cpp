...
void WindowOptions_obj::__construct(::String title, ::Dynamic __o_x, ::Dynamic __o_y, ::Dynamic __o_width, ::Dynamic __o_height, ::kha::Display display, ::Dynamic __o_visible, ::Dynamic windowFeatures, ::Dynamic __o_mode){
            		 ::Dynamic x = __o_x;
...
HXLINE(  36)		 ::kha::Display _hx_tmp;
HXDLIN(  36)		if (hx::IsNull( display )) {
HXLINE(  36)			_hx_tmp = ::kha::Display_obj::get_primary();
            		}
            		else {
HXLINE(  36)			_hx_tmp = display;
            		}
HXDLIN(  36)		this->display = _hx_tmp;
HXLINE(  37)		this->visible = ( (bool)(visible) );
HXLINE(  38)		int _hx_tmp1;
HXDLIN(  38)		if (hx::IsNull( windowFeatures )) {
HXLINE(  38)			_hx_tmp1 = ((1 | 4) | 2);
            		}
            		else {
HXLINE(  38)			_hx_tmp1 = ( (int)(windowFeatures) );
            		}
HXDLIN(  38)		this->windowFeatures = _hx_tmp1;
...
hx::ObjectPtr< WindowOptions_obj > WindowOptions_obj::__new(::String title, ::Dynamic __o_x, ::Dynamic __o_y, ::Dynamic __o_width, ::Dynamic __o_height, ::kha::Display display, ::Dynamic __o_visible, ::Dynamic windowFeatures, ::Dynamic __o_mode) {
	hx::ObjectPtr< WindowOptions_obj > __this = new WindowOptions_obj();
	__this->__construct(title,__o_x,__o_y,__o_width,__o_height,display,__o_visible,windowFeatures,__o_mode);
	return __this;
}

hx::ObjectPtr< WindowOptions_obj > WindowOptions_obj::__alloc(hx::Ctx *_hx_ctx,::String title, ::Dynamic __o_x, ::Dynamic __o_y, ::Dynamic __o_width, ::Dynamic __o_height, ::kha::Display display, ::Dynamic __o_visible, ::Dynamic windowFeatures, ::Dynamic __o_mode) {
