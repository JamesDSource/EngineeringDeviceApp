...
HXDLIN( 566)		int ch2 = data->readU8((g + 1));
HXDLIN( 566)		int n = (ch2 | (ch1 << 8));
HXDLIN( 566)		if (((n & 32768) != 0)) {
HXLINE( 566)			numberOfContours = (n - 65536);
            		}
            		else {
HXLINE( 566)			numberOfContours = n;
            		}
HXLINE( 568)		if ((numberOfContours > 0)) {
HXLINE( 569)			int flags = 0;
HXLINE( 570)			int j = 0;
HXDLIN( 570)			int next_move = 0;
HXDLIN( 570)			int off = 0;
HXLINE( 571)			bool was_off = false;
HXLINE( 572)			bool start_off = false;
HXLINE( 575)			int pointsIndex = 0;
HXLINE( 576)			endPtsOfContours = data->sub((g + 10),(data->get_length() - (g + 10)));
HXLINE( 577)			int pos = ((g + 10) + (numberOfContours * 2));
HXDLIN( 577)			int ch11 = data->readU8(pos);
HXDLIN( 577)			int ch21 = data->readU8((pos + 1));
HXLINE( 570)			int ins = (ch21 | (ch11 << 8));
HXLINE( 574)			 ::kha::internal::BytesBlob points = data->sub(((((g + 10) + (numberOfContours * 2)) + 2) + ins),(data->get_length() - ((((g + 10) + (numberOfContours * 2)) + 2) + ins)));
HXLINE( 580)			int pos1 = ((numberOfContours * 2) - 2);
HXDLIN( 580)			int ch12 = endPtsOfContours->readU8(pos1);
HXDLIN( 580)			int ch22 = endPtsOfContours->readU8((pos1 + 1));
HXLINE( 570)			int n1 = (1 + (ch22 | (ch12 << 8)));
HXDLIN( 570)			int m = (n1 + (2 * numberOfContours));
...
HXLINE( 587)				int _g = 0;
HXDLIN( 587)				int _g1 = vertices->length;
...
HXLINE( 592)			next_move = 0;
HXLINE( 569)			int flagcount = 0;
HXLINE( 599)			off = (m - n1);
HXLINE( 603)			{
HXLINE( 603)				int _g2 = 0;
HXDLIN( 603)				int _g11 = n1;
HXDLIN( 603)				while((_g2 < _g11)){
HXLINE( 603)					_g2 = (_g2 + 1);
HXDLIN( 603)					int i1 = (_g2 - 1);
HXLINE( 604)					if ((flagcount == 0)) {
HXLINE( 605)						pointsIndex = (pointsIndex + 1);
HXDLIN( 605)						flags = points->readU8((pointsIndex - 1));
HXLINE( 606)						if (((flags & 8) != 0)) {
HXLINE( 607)							pointsIndex = (pointsIndex + 1);
HXDLIN( 607)							flagcount = points->readU8((pointsIndex - 1));
            						}
            					}
            					else {
HXLINE( 609)						flagcount = (flagcount - 1);
            					}
...
HXLINE( 573)			int x = 0;
HXLINE( 615)			{
HXLINE( 615)				int _g21 = 0;
HXDLIN( 615)				int _g3 = n1;
HXDLIN( 615)				while((_g21 < _g3)){
HXLINE( 615)					_g21 = (_g21 + 1);
HXDLIN( 615)					int i2 = (_g21 - 1);
HXLINE( 616)					flags = ( ( ::kha::graphics2::truetype::Stbtt_vertex)(_hx_array_unsafe_get(vertices,(off + i2))) )->type;
HXLINE( 617)					if (((flags & 2) != 0)) {
HXLINE( 618)						pointsIndex = (pointsIndex + 1);
HXDLIN( 618)						int dx = points->readU8((pointsIndex - 1));
HXLINE( 619)						int x1;
HXDLIN( 619)						if (((flags & 16) != 0)) {
HXLINE( 619)							x1 = dx;
            						}
            						else {
HXLINE( 619)							x1 = -(dx);
...
HXLINE( 621)						if (((flags & 16) == 0)) {
HXLINE( 622)							int value;
HXLINE( 623)							int ch13 = points->readU8(pointsIndex);
HXLINE( 624)							int ch23 = points->readU8((pointsIndex + 1));
HXLINE( 625)							int n2 = (ch23 | (ch13 << 8));
HXLINE( 626)							if (((n2 & 32768) != 0)) {
HXLINE( 627)								value = (n2 - 65536);
            							}
            							else {
HXLINE( 629)								value = n2;
            							}
HXLINE( 630)							x = (x + value);
HXLINE( 631)							pointsIndex = (pointsIndex + 2);
            						}
            					}
...
HXLINE( 573)			int y = 0;
HXLINE( 639)			{
HXLINE( 639)				int _g4 = 0;
HXDLIN( 639)				int _g5 = n1;
HXDLIN( 639)				while((_g4 < _g5)){
HXLINE( 639)					_g4 = (_g4 + 1);
HXDLIN( 639)					int i3 = (_g4 - 1);
HXLINE( 640)					flags = ( ( ::kha::graphics2::truetype::Stbtt_vertex)(_hx_array_unsafe_get(vertices,(off + i3))) )->type;
HXLINE( 641)					if (((flags & 4) != 0)) {
HXLINE( 642)						pointsIndex = (pointsIndex + 1);
HXDLIN( 642)						int dy = points->readU8((pointsIndex - 1));
HXLINE( 643)						int y1;
HXDLIN( 643)						if (((flags & 32) != 0)) {
HXLINE( 643)							y1 = dy;
            						}
            						else {
HXLINE( 643)							y1 = -(dy);
...
HXLINE( 645)						if (((flags & 32) == 0)) {
HXLINE( 646)							int value1;
HXLINE( 647)							int ch14 = points->readU8(pointsIndex);
HXLINE( 648)							int ch24 = points->readU8((pointsIndex + 1));
HXLINE( 649)							int n3 = (ch24 | (ch14 << 8));
HXLINE( 650)							if (((n3 & 32768) != 0)) {
HXLINE( 651)								value1 = (n3 - 65536);
            							}
            							else {
HXLINE( 653)								value1 = n3;
            							}
HXLINE( 654)							y = (y + value1);
HXLINE( 655)							pointsIndex = (pointsIndex + 2);
            						}
            					}
HXLINE( 658)					( ( ::kha::graphics2::truetype::Stbtt_vertex)(_hx_array_unsafe_get(vertices,(off + i3))) )->y = y;
            				}
            			}
HXLINE( 662)			num_vertices = 0;
HXLINE( 573)			int scy = 0;
HXDLIN( 573)			int scx = scy;
HXDLIN( 573)			int cy = scx;
HXDLIN( 573)			int cx = cy;
HXDLIN( 573)			int sy = cx;
HXDLIN( 573)			int sx = sy;
HXLINE( 664)			int i4 = 0;
...
HXLINE( 675)					start_off = ((flags & 1) == 0);
HXLINE( 676)					if (start_off) {
HXLINE( 679)						scx = x;
HXLINE( 680)						scy = y;
HXLINE( 681)						if (((( ( ::kha::graphics2::truetype::Stbtt_vertex)(_hx_array_unsafe_get(vertices,((off + i4) + 1))) )->type & 1) == 0)) {
HXLINE( 683)							sx = ((x + ( ( ::kha::graphics2::truetype::Stbtt_vertex)(_hx_array_unsafe_get(vertices,((off + i4) + 1))) )->x) >> 1);
HXLINE( 684)							sy = ((y + ( ( ::kha::graphics2::truetype::Stbtt_vertex)(_hx_array_unsafe_get(vertices,((off + i4) + 1))) )->y) >> 1);
            						}
            						else {
HXLINE( 687)							sx = ( ( ::kha::graphics2::truetype::Stbtt_vertex)(_hx_array_unsafe_get(vertices,((off + i4) + 1))) )->x;
HXLINE( 688)							sy = ( ( ::kha::graphics2::truetype::Stbtt_vertex)(_hx_array_unsafe_get(vertices,((off + i4) + 1))) )->y;
HXLINE( 689)							i4 = (i4 + 1);
            						}
            					}
            					else {
...
HXLINE( 695)					num_vertices = (num_vertices + 1);
HXDLIN( 695)					::kha::graphics2::truetype::StbTruetype_obj::stbtt_setvertex(( ( ::kha::graphics2::truetype::Stbtt_vertex)(_hx_array_unsafe_get(vertices,(num_vertices - 1))) ),1,sx,sy,0,0);
HXLINE( 696)					was_off = false;
HXLINE( 697)					int pos2 = (j * 2);
HXDLIN( 697)					int ch15 = endPtsOfContours->readU8(pos2);
HXDLIN( 697)					int ch25 = endPtsOfContours->readU8((pos2 + 1));
HXDLIN( 697)					next_move = (1 + (ch25 | (ch15 << 8)));
HXLINE( 698)					j = (j + 1);
            				}
            				else {
HXLINE( 700)					if (((flags & 1) == 0)) {
HXLINE( 701)						if (was_off) {
HXLINE( 702)							num_vertices = (num_vertices + 1);
HXDLIN( 702)							::kha::graphics2::truetype::StbTruetype_obj::stbtt_setvertex(( ( ::kha::graphics2::truetype::Stbtt_vertex)(_hx_array_unsafe_get(vertices,(num_vertices - 1))) ),3,((cx + x) >> 1),((cy + y) >> 1),cx,cy);
            						}
HXLINE( 703)						cx = x;
HXLINE( 704)						cy = y;
...
HXLINE( 708)							num_vertices = (num_vertices + 1);
HXDLIN( 708)							::kha::graphics2::truetype::StbTruetype_obj::stbtt_setvertex(( ( ::kha::graphics2::truetype::Stbtt_vertex)(_hx_array_unsafe_get(vertices,(num_vertices - 1))) ),3,x,y,cx,cy);
            						}
            						else {
HXLINE( 710)							num_vertices = (num_vertices + 1);
HXDLIN( 710)							::kha::graphics2::truetype::StbTruetype_obj::stbtt_setvertex(( ( ::kha::graphics2::truetype::Stbtt_vertex)(_hx_array_unsafe_get(vertices,(num_vertices - 1))) ),2,x,y,0,0);
            						}
...
HXLINE( 717)			if ((numberOfContours == -1)) {
HXLINE( 719)				int more = 1;
HXLINE( 720)				 ::kha::internal::BytesBlob comp = data->sub((g + 10),(data->get_length() - (g + 10)));
HXLINE( 721)				int compIndex = 0;
HXLINE( 722)				num_vertices = 0;
HXLINE( 723)				vertices = null();
HXLINE( 724)				while((more != 0)){
HXLINE( 725)					int flags1;
HXDLIN( 725)					int gidx;
HXLINE( 726)					int comp_num_verts = 0;
HXDLIN( 726)					int i5;
HXLINE( 727)					::Array< ::Dynamic> comp_verts = null();
HXLINE( 728)					::Array< ::Dynamic> tmp = null();
HXLINE( 729)					Float mtx0 = ( (Float)(1) );
HXLINE( 730)					Float mtx1 = ( (Float)(0) );
HXLINE( 731)					Float mtx2 = ( (Float)(0) );
HXLINE( 732)					Float mtx3 = ( (Float)(1) );
HXLINE( 733)					Float mtx4 = ( (Float)(0) );
HXLINE( 734)					Float mtx5 = ( (Float)(0) );
HXLINE( 737)					int ch16 = comp->readU8(compIndex);
HXDLIN( 737)					int ch26 = comp->readU8((compIndex + 1));
HXDLIN( 737)					int n4 = (ch26 | (ch16 << 8));
HXDLIN( 737)					if (((n4 & 32768) != 0)) {
HXLINE( 737)						flags1 = (n4 - 65536);
            					}
            					else {
HXLINE( 737)						flags1 = n4;
            					}
HXDLIN( 737)					compIndex = (compIndex + 2);
HXLINE( 738)					int ch17 = comp->readU8(compIndex);
HXDLIN( 738)					int ch27 = comp->readU8((compIndex + 1));
HXDLIN( 738)					int n5 = (ch27 | (ch17 << 8));
HXDLIN( 738)					if (((n5 & 32768) != 0)) {
HXLINE( 738)						gidx = (n5 - 65536);
            					}
            					else {
HXLINE( 738)						gidx = n5;
            					}
HXDLIN( 738)					compIndex = (compIndex + 2);
HXLINE( 740)					if (((flags1 & 2) != 0)) {
HXLINE( 741)						if (((flags1 & 1) != 0)) {
HXLINE( 742)							int ch18 = comp->readU8(compIndex);
HXDLIN( 742)							int ch28 = comp->readU8((compIndex + 1));
HXDLIN( 742)							int n6 = (ch28 | (ch18 << 8));
HXDLIN( 742)							if (((n6 & 32768) != 0)) {
HXLINE( 742)								mtx4 = ( (Float)((n6 - 65536)) );
            							}
            							else {
HXLINE( 742)								mtx4 = ( (Float)(n6) );
            							}
HXDLIN( 742)							compIndex = (compIndex + 2);
HXLINE( 743)							int ch19 = comp->readU8(compIndex);
HXDLIN( 743)							int ch29 = comp->readU8((compIndex + 1));
HXDLIN( 743)							int n7 = (ch29 | (ch19 << 8));
HXDLIN( 743)							if (((n7 & 32768) != 0)) {
HXLINE( 743)								mtx5 = ( (Float)((n7 - 65536)) );
            							}
            							else {
HXLINE( 743)								mtx5 = ( (Float)(n7) );
            							}
HXDLIN( 743)							compIndex = (compIndex + 2);
            						}
            						else {
HXLINE( 745)							int n8 = comp->readU8(compIndex);
HXDLIN( 745)							if ((n8 >= 128)) {
HXLINE( 745)								mtx4 = ( (Float)((n8 - 256)) );
            							}
            							else {
HXLINE( 745)								mtx4 = ( (Float)(n8) );
            							}
HXDLIN( 745)							compIndex = (compIndex + 1);
HXLINE( 746)							int n9 = comp->readU8(compIndex);
HXDLIN( 746)							if ((n9 >= 128)) {
HXLINE( 746)								mtx5 = ( (Float)((n9 - 256)) );
            							}
            							else {
HXLINE( 746)								mtx5 = ( (Float)(n9) );
            							}
HXDLIN( 746)							compIndex = (compIndex + 1);
            						}
            					}
            					else {
HXLINE( 751)						HX_STACK_DO_THROW(HX_("Error",a8,3b,57,06));
            					}
HXLINE( 753)					if (((flags1 & 8) != 0)) {
HXLINE( 754)						int ch110 = comp->readU8(compIndex);
HXDLIN( 754)						int ch210 = comp->readU8((compIndex + 1));
HXDLIN( 754)						int n10 = (ch210 | (ch110 << 8));
HXDLIN( 754)						int mtx31;
HXDLIN( 754)						if (((n10 & 32768) != 0)) {
HXLINE( 754)							mtx31 = (n10 - 65536);
            						}
            						else {
HXLINE( 754)							mtx31 = n10;
            						}
HXDLIN( 754)						mtx3 = (( (Float)(mtx31) ) / ((Float)16384.0));
HXDLIN( 754)						mtx0 = mtx3;
HXDLIN( 754)						compIndex = (compIndex + 2);
HXLINE( 755)						mtx2 = ( (Float)(0) );
HXDLIN( 755)						mtx1 = mtx2;
            					}
            					else {
HXLINE( 756)						if (((flags1 & 64) != 0)) {
HXLINE( 757)							int ch111 = comp->readU8(compIndex);
HXDLIN( 757)							int ch211 = comp->readU8((compIndex + 1));
HXDLIN( 757)							int n11 = (ch211 | (ch111 << 8));
HXDLIN( 757)							int mtx01;
HXDLIN( 757)							if (((n11 & 32768) != 0)) {
HXLINE( 757)								mtx01 = (n11 - 65536);
            							}
            							else {
HXLINE( 757)								mtx01 = n11;
            							}
HXDLIN( 757)							mtx0 = (( (Float)(mtx01) ) / ((Float)16384.0));
HXDLIN( 757)							compIndex = (compIndex + 2);
HXLINE( 758)							mtx2 = ( (Float)(0) );
HXDLIN( 758)							mtx1 = mtx2;
HXLINE( 759)							int ch112 = comp->readU8(compIndex);
HXDLIN( 759)							int ch212 = comp->readU8((compIndex + 1));
HXDLIN( 759)							int n12 = (ch212 | (ch112 << 8));
HXDLIN( 759)							int mtx32;
HXDLIN( 759)							if (((n12 & 32768) != 0)) {
HXLINE( 759)								mtx32 = (n12 - 65536);
            							}
            							else {
HXLINE( 759)								mtx32 = n12;
            							}
HXDLIN( 759)							mtx3 = (( (Float)(mtx32) ) / ((Float)16384.0));
HXDLIN( 759)							compIndex = (compIndex + 2);
            						}
            						else {
HXLINE( 760)							if (((flags1 & 128) != 0)) {
HXLINE( 761)								int ch113 = comp->readU8(compIndex);
HXDLIN( 761)								int ch213 = comp->readU8((compIndex + 1));
HXDLIN( 761)								int n13 = (ch213 | (ch113 << 8));
HXDLIN( 761)								int mtx02;
HXDLIN( 761)								if (((n13 & 32768) != 0)) {
HXLINE( 761)									mtx02 = (n13 - 65536);
            								}
            								else {
HXLINE( 761)									mtx02 = n13;
            								}
HXDLIN( 761)								mtx0 = (( (Float)(mtx02) ) / ((Float)16384.0));
HXDLIN( 761)								compIndex = (compIndex + 2);
HXLINE( 762)								int ch114 = comp->readU8(compIndex);
HXDLIN( 762)								int ch214 = comp->readU8((compIndex + 1));
HXDLIN( 762)								int n14 = (ch214 | (ch114 << 8));
HXDLIN( 762)								int mtx11;
HXDLIN( 762)								if (((n14 & 32768) != 0)) {
HXLINE( 762)									mtx11 = (n14 - 65536);
            								}
            								else {
HXLINE( 762)									mtx11 = n14;
            								}
HXDLIN( 762)								mtx1 = (( (Float)(mtx11) ) / ((Float)16384.0));
HXDLIN( 762)								compIndex = (compIndex + 2);
HXLINE( 763)								int ch115 = comp->readU8(compIndex);
HXDLIN( 763)								int ch215 = comp->readU8((compIndex + 1));
HXDLIN( 763)								int n15 = (ch215 | (ch115 << 8));
HXDLIN( 763)								int mtx21;
HXDLIN( 763)								if (((n15 & 32768) != 0)) {
HXLINE( 763)									mtx21 = (n15 - 65536);
            								}
            								else {
HXLINE( 763)									mtx21 = n15;
            								}
HXDLIN( 763)								mtx2 = (( (Float)(mtx21) ) / ((Float)16384.0));
HXDLIN( 763)								compIndex = (compIndex + 2);
HXLINE( 764)								int ch116 = comp->readU8(compIndex);
HXDLIN( 764)								int ch216 = comp->readU8((compIndex + 1));
HXDLIN( 764)								int n16 = (ch216 | (ch116 << 8));
HXDLIN( 764)								int mtx33;
HXDLIN( 764)								if (((n16 & 32768) != 0)) {
HXLINE( 764)									mtx33 = (n16 - 65536);
            								}
            								else {
HXLINE( 764)									mtx33 = n16;
            								}
HXDLIN( 764)								mtx3 = (( (Float)(mtx33) ) / ((Float)16384.0));
HXDLIN( 764)								compIndex = (compIndex + 2);
            							}
            						}
            					}
HXLINE( 735)					Float m1 = ::Math_obj::sqrt(((mtx0 * mtx0) + (mtx1 * mtx1)));
HXDLIN( 735)					Float n17 = ::Math_obj::sqrt(((mtx2 * mtx2) + (mtx3 * mtx3)));
...
HXLINE( 773)						comp_num_verts = 0;
            					}
            					else {
HXLINE( 773)						comp_num_verts = comp_verts->length;
            					}
HXLINE( 774)					if ((comp_num_verts > 0)) {
HXLINE( 776)						{
HXLINE( 776)							int _g6 = 0;
HXDLIN( 776)							int _g12 = comp_num_verts;
HXDLIN( 776)							while((_g6 < _g12)){
HXLINE( 776)								_g6 = (_g6 + 1);
HXDLIN( 776)								int i6 = (_g6 - 1);
HXLINE( 777)								 ::kha::graphics2::truetype::Stbtt_vertex v = ( ( ::kha::graphics2::truetype::Stbtt_vertex)(_hx_array_unsafe_get(comp_verts,i6)) );
HXLINE( 778)								int x2 = v->x;
HXDLIN( 778)								int y2 = v->y;
HXLINE( 780)								v->x = ::Std_obj::_hx_int((m1 * (((mtx0 * ( (Float)(x2) )) + (mtx2 * ( (Float)(y2) ))) + mtx4)));
HXLINE( 781)								v->y = ::Std_obj::_hx_int((n17 * (((mtx1 * ( (Float)(x2) )) + (mtx3 * ( (Float)(y2) ))) + mtx5)));
HXLINE( 782)								x2 = v->cx;
HXDLIN( 782)								y2 = v->cy;
HXLINE( 783)								v->cx = ::Std_obj::_hx_int((m1 * (((mtx0 * ( (Float)(x2) )) + (mtx2 * ( (Float)(y2) ))) + mtx4)));
HXLINE( 784)								v->cy = ::Std_obj::_hx_int((n17 * (((mtx1 * ( (Float)(x2) )) + (mtx3 * ( (Float)(y2) ))) + mtx5)));
            							}
            						}
...
HXLINE( 791)						if ((num_vertices > 0)) {
HXLINE( 791)							::kha::graphics2::truetype::StbTruetype_obj::copyVertices(vertices,tmp,0,num_vertices);
            						}
...
HXLINE( 797)					more = (flags1 & 32);
            				}
            			}
            			else {
HXLINE( 799)				if ((numberOfContours < 0)) {
...
HXLINE( 810)			::kha::graphics2::truetype::StbTruetype_obj::copyVertices(vertices,tmp1,0,num_vertices);
...
HXDLIN( 819)		int pos = (info->hhea + 34);
HXDLIN( 819)		int ch1 = p->readU8(pos);
HXDLIN( 819)		int ch2 = p->readU8((pos + 1));
HXDLIN( 819)		int numOfLongHorMetrics = (ch2 | (ch1 << 8));
...
HXDLIN( 822)			int pos1 = (info->hmtx + (4 * glyph_index));
HXDLIN( 822)			int ch11 = p1->readU8(pos1);
HXDLIN( 822)			int ch21 = p1->readU8((pos1 + 1));
HXDLIN( 822)			int n = (ch21 | (ch11 << 8));
HXDLIN( 822)			int _hx_tmp;
HXDLIN( 822)			if (((n & 32768) != 0)) {
HXLINE( 822)				_hx_tmp = (n - 65536);
            			}
            			else {
...
HXDLIN( 823)			int pos2 = ((info->hmtx + (4 * glyph_index)) + 2);
HXDLIN( 823)			int ch12 = p2->readU8(pos2);
HXDLIN( 823)			int ch22 = p2->readU8((pos2 + 1));
HXDLIN( 823)			int n1 = (ch22 | (ch12 << 8));
HXDLIN( 823)			int _hx_tmp1;
HXDLIN( 823)			if (((n1 & 32768) != 0)) {
HXLINE( 823)				_hx_tmp1 = (n1 - 65536);
            			}
            			else {
...
HXDLIN( 825)			int pos3 = (info->hmtx + (4 * (numOfLongHorMetrics - 1)));
HXDLIN( 825)			int ch13 = p3->readU8(pos3);
HXDLIN( 825)			int ch23 = p3->readU8((pos3 + 1));
HXDLIN( 825)			int n2 = (ch23 | (ch13 << 8));
HXDLIN( 825)			int _hx_tmp2;
HXDLIN( 825)			if (((n2 & 32768) != 0)) {
HXLINE( 825)				_hx_tmp2 = (n2 - 65536);
            			}
            			else {
...
HXDLIN( 826)			int pos4 = ((info->hmtx + (4 * numOfLongHorMetrics)) + (2 * (glyph_index - numOfLongHorMetrics)));
HXDLIN( 826)			int ch14 = p4->readU8(pos4);
HXDLIN( 826)			int ch24 = p4->readU8((pos4 + 1));
HXDLIN( 826)			int n3 = (ch24 | (ch14 << 8));
HXDLIN( 826)			int _hx_tmp3;
HXDLIN( 826)			if (((n3 & 32768) != 0)) {
HXLINE( 826)				_hx_tmp3 = (n3 - 65536);
            			}
            			else {
...
HXLINE( 833)		int straw;
HXLINE( 834)		int m;
HXLINE( 837)		if ((info->kern == 0)) {
HXLINE( 838)			return 0;
            		}
HXLINE( 839)		int ch1 = data1->readU8(2);
HXDLIN( 839)		int ch2 = data1->readU8(3);
HXDLIN( 839)		if (((ch2 | (ch1 << 8)) < 1)) {
HXLINE( 840)			return 0;
            		}
HXLINE( 841)		int ch11 = data1->readU8(8);
HXDLIN( 841)		int ch21 = data1->readU8(9);
HXDLIN( 841)		if (((ch21 | (ch11 << 8)) != 1)) {
HXLINE( 842)			return 0;
            		}
HXLINE( 834)		int l = 0;
HXLINE( 845)		int ch12 = data1->readU8(10);
HXDLIN( 845)		int ch22 = data1->readU8(11);
HXLINE( 834)		int r = ((ch22 | (ch12 << 8)) - 1);
HXLINE( 833)		int needle = ((glyph1 << 16) | glyph2);
HXLINE( 847)		while((l <= r)){
HXLINE( 848)			m = ((l + r) >> 1);
HXLINE( 849)			int pos = (18 + (m * 6));
HXDLIN( 849)			int ch13 = data1->readU8(pos);
HXDLIN( 849)			int ch23 = data1->readU8((pos + 1));
HXDLIN( 849)			int ch3 = data1->readU8((pos + 2));
HXDLIN( 849)			int ch4 = data1->readU8((pos + 3));
HXDLIN( 849)			straw = (((ch4 | (ch3 << 8)) | (ch23 << 16)) | (ch13 << 24));
...
HXLINE( 855)					int pos1 = (22 + (m * 6));
HXDLIN( 855)					int ch14 = data1->readU8(pos1);
HXDLIN( 855)					int ch24 = data1->readU8((pos1 + 1));
HXDLIN( 855)					int n = (ch24 | (ch14 << 8));
HXDLIN( 855)					if (((n & 32768) != 0)) {
HXLINE( 855)						return (n - 65536);
            					}
            					else {
HXLINE( 855)						return n;
            					}
...
HXDLIN( 872)		int pos = (info->hhea + 4);
HXDLIN( 872)		int ch1 = p->readU8(pos);
HXDLIN( 872)		int ch2 = p->readU8((pos + 1));
HXDLIN( 872)		int n = (ch2 | (ch1 << 8));
HXDLIN( 872)		int _hx_tmp;
HXDLIN( 872)		if (((n & 32768) != 0)) {
HXLINE( 872)			_hx_tmp = (n - 65536);
            		}
            		else {
...
HXDLIN( 873)		int pos1 = (info->hhea + 6);
HXDLIN( 873)		int ch11 = p1->readU8(pos1);
HXDLIN( 873)		int ch21 = p1->readU8((pos1 + 1));
HXDLIN( 873)		int n1 = (ch21 | (ch11 << 8));
HXDLIN( 873)		int _hx_tmp1;
HXDLIN( 873)		if (((n1 & 32768) != 0)) {
HXLINE( 873)			_hx_tmp1 = (n1 - 65536);
            		}
            		else {
...
HXDLIN( 874)		int pos2 = (info->hhea + 8);
HXDLIN( 874)		int ch12 = p2->readU8(pos2);
HXDLIN( 874)		int ch22 = p2->readU8((pos2 + 1));
HXDLIN( 874)		int n2 = (ch22 | (ch12 << 8));
HXDLIN( 874)		int _hx_tmp2;
HXDLIN( 874)		if (((n2 & 32768) != 0)) {
HXLINE( 874)			_hx_tmp2 = (n2 - 65536);
            		}
            		else {
...
HXDLIN( 880)		int pos = (info->head + 36);
HXDLIN( 880)		int ch1 = p->readU8(pos);
HXDLIN( 880)		int ch2 = p->readU8((pos + 1));
HXDLIN( 880)		int n = (ch2 | (ch1 << 8));
HXDLIN( 880)		int _hx_tmp;
HXDLIN( 880)		if (((n & 32768) != 0)) {
HXLINE( 880)			_hx_tmp = (n - 65536);
            		}
            		else {
...
HXDLIN( 881)		int pos1 = (info->head + 38);
HXDLIN( 881)		int ch11 = p1->readU8(pos1);
HXDLIN( 881)		int ch21 = p1->readU8((pos1 + 1));
HXDLIN( 881)		int n1 = (ch21 | (ch11 << 8));
HXDLIN( 881)		int _hx_tmp1;
HXDLIN( 881)		if (((n1 & 32768) != 0)) {
HXLINE( 881)			_hx_tmp1 = (n1 - 65536);
            		}
            		else {
...
HXDLIN( 882)		int pos2 = (info->head + 40);
HXDLIN( 882)		int ch12 = p2->readU8(pos2);
HXDLIN( 882)		int ch22 = p2->readU8((pos2 + 1));
HXDLIN( 882)		int n2 = (ch22 | (ch12 << 8));
HXDLIN( 882)		int _hx_tmp2;
HXDLIN( 882)		if (((n2 & 32768) != 0)) {
HXLINE( 882)			_hx_tmp2 = (n2 - 65536);
            		}
            		else {
...
HXDLIN( 883)		int pos3 = (info->head + 42);
HXDLIN( 883)		int ch13 = p3->readU8(pos3);
HXDLIN( 883)		int ch23 = p3->readU8((pos3 + 1));
HXDLIN( 883)		int n3 = (ch23 | (ch13 << 8));
HXDLIN( 883)		int _hx_tmp3;
HXDLIN( 883)		if (((n3 & 32768) != 0)) {
HXLINE( 883)			_hx_tmp3 = (n3 - 65536);
            		}
            		else {
...
HXDLIN( 888)		int pos = (info->hhea + 4);
HXDLIN( 888)		int ch1 = p->readU8(pos);
HXDLIN( 888)		int ch2 = p->readU8((pos + 1));
HXDLIN( 888)		int n = (ch2 | (ch1 << 8));
HXDLIN( 888)		int fheight;
HXDLIN( 888)		if (((n & 32768) != 0)) {
HXLINE( 888)			fheight = (n - 65536);
            		}
            		else {
HXLINE( 888)			fheight = n;
            		}
HXDLIN( 888)		 ::kha::internal::BytesBlob p1 = info->data;
HXDLIN( 888)		int pos1 = (info->hhea + 6);
HXDLIN( 888)		int ch11 = p1->readU8(pos1);
HXDLIN( 888)		int ch21 = p1->readU8((pos1 + 1));
HXDLIN( 888)		int n1 = (ch21 | (ch11 << 8));
HXDLIN( 888)		int fheight1;
HXDLIN( 888)		if (((n1 & 32768) != 0)) {
HXLINE( 888)			fheight1 = (n1 - 65536);
            		}
            		else {
HXLINE( 888)			fheight1 = n1;
            		}
HXDLIN( 888)		int fheight2 = (fheight - fheight1);
HXLINE( 889)		return (height / ( (Float)(fheight2) ));
            	}
...
HXDLIN( 893)		int pos = (info->head + 18);
HXDLIN( 893)		int ch1 = p->readU8(pos);
HXDLIN( 893)		int ch2 = p->readU8((pos + 1));
HXDLIN( 893)		int unitsPerEm = (ch2 | (ch1 << 8));
HXLINE( 894)		return (pixels / ( (Float)(unitsPerEm) ));
            	}
...
HXLINE( 906)			rect->x0 = 0;
HXLINE( 907)			rect->y0 = 0;
HXLINE( 908)			rect->x1 = 0;
HXLINE( 909)			rect->y1 = 0;
            		}
            		else {
...
HXLINE( 916)			rect->x0 = ::Math_obj::floor(((( (Float)(x0) ) * scale_x) + shift_x));
HXLINE( 917)			rect->y0 = ::Math_obj::floor(((( (Float)(-(y1)) ) * scale_y) + shift_y));
HXLINE( 918)			rect->x1 = ::Math_obj::ceil(((( (Float)(x1) ) * scale_x) + shift_x));
HXLINE( 919)			rect->y1 = ::Math_obj::ceil(((( (Float)(-(y0)) ) * scale_y) + shift_y));
            		}
...
HXDLIN( 942)		Float dxdy3 = (dxdy1 / (dxdy2 - ( ( ::kha::graphics2::truetype::Stbtt__edge)(_hx_array_unsafe_get(e,eIndex)) )->y0));
...
HXLINE( 946)			_hx_tmp = (((Float)1.0) / dxdy3);
            		}
            		else {
...
HXDLIN( 948)		z1->fx = (z1->fx - ( (Float)(off_x) ));
...
HXLINE( 965)			x0 = (x0 + (((x1 - x0) * (e->sy - y0)) / (y1 - y0)));
HXLINE( 966)			y0 = e->sy;
            		}
HXLINE( 968)		if ((y1 > e->ey)) {
HXLINE( 969)			x1 = (x1 + (((x1 - x0) * (e->ey - y1)) / (y1 - y0)));
HXLINE( 970)			y1 = e->ey;
            		}
HXLINE( 973)		if ((x0 == x)) {
HXLINE( 974)			if (!((x1 <= (x + 1)))) {
HXLINE( 974)				HX_STACK_DO_THROW(HX_("Error",a8,3b,57,06));
            			}
            		}
            		else {
HXLINE( 975)			if ((x0 == (x + 1))) {
HXLINE( 976)				if (!((x1 >= x))) {
...
HXLINE( 979)					if ((x0 >= (x + 1))) {
HXLINE( 980)						if (!((x1 >= (x + 1)))) {
...
HXDLIN( 985)				_g1->__unsafe_set(_g,(val + (e->direction * (y1 - y0))));
            			}
            		}
            		else {
HXLINE( 986)			bool _hx_tmp2;
HXDLIN( 986)			if ((x0 >= (x + 1))) {
HXLINE( 986)				_hx_tmp2 = (x1 >= (x + 1));
            			}
            			else {
...
HXDLIN( 990)						_g11->__unsafe_set(_g2,(val1 + ((e->direction * (y1 - y0)) * (( (Float)(1) ) - (((x0 - ( (Float)(x) )) + (x1 - ( (Float)(x) ))) / ( (Float)(2) ))))));
            					}
            				}
            			}
            		}
...
HXLINE( 995)		Float y_bottom = (y_top + 1);
HXLINE( 997)		while(hx::IsNotNull( e )){
HXLINE(1001)			if (!((e->ey >= y_top))) {
HXLINE(1001)				HX_STACK_DO_THROW(HX_("Error",a8,3b,57,06));
            			}
HXLINE(1003)			if ((e->fdx == 0)) {
HXLINE(1004)				Float x0 = e->fx;
HXLINE(1005)				if ((x0 < len)) {
HXLINE(1006)					if ((x0 >= 0)) {
HXLINE(1007)						::kha::graphics2::truetype::StbTruetype_obj::stbtt__handle_clipped_edge(scanline,0,::Std_obj::_hx_int(x0),e,x0,y_top,x0,y_bottom);
HXLINE(1008)						::kha::graphics2::truetype::StbTruetype_obj::stbtt__handle_clipped_edge(scanline_fill,(scanline_fillIndex - 1),::Std_obj::_hx_int((x0 + 1)),e,x0,y_top,x0,y_bottom);
            					}
            					else {
HXLINE(1010)						::kha::graphics2::truetype::StbTruetype_obj::stbtt__handle_clipped_edge(scanline_fill,(scanline_fillIndex - 1),0,e,x0,y_top,x0,y_bottom);
            					}
            				}
            			}
            			else {
...
HXLINE(1020)					_hx_tmp = (e->ey >= y_top);
            				}
            				else {
...
HXDLIN(1040)				bool _hx_tmp3;
HXDLIN(1040)				if ((x_top >= 0)) {
HXLINE(1040)					_hx_tmp3 = (x_bottom >= 0);
            				}
            				else {
HXLINE(1040)					_hx_tmp3 = false;
            				}
HXDLIN(1040)				if (_hx_tmp3) {
HXLINE(1040)					_hx_tmp2 = (x_top < len);
            				}
            				else {
HXLINE(1040)					_hx_tmp2 = false;
            				}
HXDLIN(1040)				if (_hx_tmp2) {
HXLINE(1040)					_hx_tmp1 = (x_bottom < len);
            				}
            				else {
HXLINE(1040)					_hx_tmp1 = false;
            				}
HXDLIN(1040)				if (_hx_tmp1) {
HXLINE(1043)					int _hx_tmp4 = ::Std_obj::_hx_int(x_top);
HXDLIN(1043)					if ((_hx_tmp4 == ::Std_obj::_hx_int(x_bottom))) {
HXLINE(1046)						int x = ::Std_obj::_hx_int(x_top);
HXLINE(1044)						Float height = (sy1 - sy0);
HXLINE(1048)						bool _hx_tmp5;
HXDLIN(1048)						if ((x >= 0)) {
HXLINE(1048)							_hx_tmp5 = (x < len);
            						}
            						else {
HXLINE(1048)							_hx_tmp5 = false;
            						}
HXDLIN(1048)						if (!(_hx_tmp5)) {
...
HXDLIN(1049)								_g1->__unsafe_set(_g,(val + ((e->direction * (( (Float)(1) ) - (((x_top - ( (Float)(x) )) + (x_bottom - ( (Float)(x) ))) / ( (Float)(2) )))) * height)));
            							}
            						}
HXLINE(1050)						{
...
HXLINE(1052)						int x11 = ::Std_obj::_hx_int(x_top);
HXDLIN(1052)						int x2 = ::Std_obj::_hx_int(x_bottom);
HXLINE(1053)						Float y_crossing = (((( (Float)((x11 + 1)) ) - x01) * dy) + y_top);
HXDLIN(1053)						Float sign = e->direction;
HXDLIN(1053)						Float area = (sign * (y_crossing - sy0));
HXLINE(1076)						{
HXLINE(1076)							int _g3 = x11;
HXDLIN(1076)							::Array< Float > _g12 = scanline;
HXDLIN(1076)							{
HXLINE(1076)								Float val2 = (( (Float)(_hx_array_unsafe_get(_g12,_g3)) ) + (area * (( (Float)(1) ) - (((x_top - ( (Float)(x11) )) + ((x11 + 1) - x11)) / ( (Float)(2) )))));
HXDLIN(1076)								_g12->__unsafe_set(_g3,val2);
            							}
            						}
HXLINE(1053)						Float step = (sign * dy);
HXLINE(1079)						{
HXLINE(1079)							int _g4 = (x11 + 1);
HXDLIN(1079)							int _g13 = x2;
HXDLIN(1079)							while((_g4 < _g13)){
HXLINE(1079)								_g4 = (_g4 + 1);
HXDLIN(1079)								int x3 = (_g4 - 1);
HXLINE(1080)								{
HXLINE(1080)									int _g5 = x3;
HXDLIN(1080)									::Array< Float > _g14 = scanline;
HXDLIN(1080)									{
HXLINE(1080)										Float val3 = (( (Float)(_hx_array_unsafe_get(_g14,_g5)) ) + (area + (step / ( (Float)(2) ))));
HXDLIN(1080)										_g14->__unsafe_set(_g5,val3);
            									}
            								}
HXLINE(1081)								area = (area + step);
            							}
            						}
HXLINE(1083)						y_crossing = (y_crossing + (dy * ( (Float)((x2 - (x11 + 1))) )));
HXLINE(1085)						if (!((::Math_obj::abs(area) <= ((Float)1.01)))) {
HXLINE(1085)							HX_STACK_DO_THROW(HX_("Error",a8,3b,57,06));
            						}
HXLINE(1087)						{
HXLINE(1087)							int _g21 = x2;
HXDLIN(1087)							::Array< Float > _g31 = scanline;
HXDLIN(1087)							{
HXLINE(1087)								Float val4 = (( (Float)(_hx_array_unsafe_get(_g31,_g21)) ) + (area + ((sign * (( (Float)(1) ) - (((x2 - x2) + (x_bottom - ( (Float)(x2) ))) / ( (Float)(2) )))) * (sy1 - y_crossing))));
HXDLIN(1087)								_g31->__unsafe_set(_g21,val4);
            							}
            						}
HXLINE(1089)						{
HXLINE(1089)							int _g22 = (scanline_fillIndex + x2);
HXDLIN(1089)							::Array< Float > _g32 = scanline_fill;
HXDLIN(1089)							{
HXLINE(1089)								Float val5 = (( (Float)(_hx_array_unsafe_get(_g32,_g22)) ) + (sign * (sy1 - sy0)));
HXDLIN(1089)								_g32->__unsafe_set(_g22,val5);
            							}
            						}
            					}
            				}
            				else {
HXLINE(1096)					int _g6 = 0;
HXDLIN(1096)					int _g15 = len;
HXDLIN(1096)					while((_g6 < _g15)){
HXLINE(1096)						_g6 = (_g6 + 1);
HXDLIN(1096)						int x4 = (_g6 - 1);
HXLINE(1111)						Float y0 = y_top;
HXLINE(1112)						Float x12 = ( (Float)(x4) );
HXLINE(1113)						Float x21 = ( (Float)((x4 + 1)) );
HXLINE(1114)						Float x31 = xb;
HXLINE(1115)						Float y3 = y_bottom;
HXLINE(1116)						Float y1 = (((( (Float)(x4) ) - x01) / dx) + y_top);
HXDLIN(1116)						Float y2 = (((( (Float)((x4 + 1)) ) - x01) / dx) + y_top);
HXLINE(1124)						bool _hx_tmp6;
HXDLIN(1124)						if ((x01 < x12)) {
HXLINE(1124)							_hx_tmp6 = (x31 > x21);
            						}
            						else {
HXLINE(1124)							_hx_tmp6 = false;
            						}
HXDLIN(1124)						if (_hx_tmp6) {
HXLINE(1125)							::kha::graphics2::truetype::StbTruetype_obj::stbtt__handle_clipped_edge(scanline,0,x4,e,x01,y0,x12,y1);
HXLINE(1126)							::kha::graphics2::truetype::StbTruetype_obj::stbtt__handle_clipped_edge(scanline,0,x4,e,x12,y1,x21,y2);
HXLINE(1127)							::kha::graphics2::truetype::StbTruetype_obj::stbtt__handle_clipped_edge(scanline,0,x4,e,x21,y2,x31,y3);
            						}
            						else {
HXLINE(1128)							bool _hx_tmp7;
HXDLIN(1128)							if ((x31 < x12)) {
HXLINE(1128)								_hx_tmp7 = (x01 > x21);
            							}
            							else {
HXLINE(1128)								_hx_tmp7 = false;
            							}
HXDLIN(1128)							if (_hx_tmp7) {
HXLINE(1129)								::kha::graphics2::truetype::StbTruetype_obj::stbtt__handle_clipped_edge(scanline,0,x4,e,x01,y0,x21,y2);
HXLINE(1130)								::kha::graphics2::truetype::StbTruetype_obj::stbtt__handle_clipped_edge(scanline,0,x4,e,x21,y2,x12,y1);
HXLINE(1131)								::kha::graphics2::truetype::StbTruetype_obj::stbtt__handle_clipped_edge(scanline,0,x4,e,x12,y1,x31,y3);
            							}
            							else {
HXLINE(1132)								bool _hx_tmp8;
HXDLIN(1132)								if ((x01 < x12)) {
HXLINE(1132)									_hx_tmp8 = (x31 > x12);
            								}
            								else {
HXLINE(1132)									_hx_tmp8 = false;
            								}
HXDLIN(1132)								if (_hx_tmp8) {
...
HXLINE(1135)									bool _hx_tmp9;
HXDLIN(1135)									if ((x31 < x12)) {
HXLINE(1135)										_hx_tmp9 = (x01 > x12);
            									}
            									else {
HXLINE(1135)										_hx_tmp9 = false;
            									}
HXDLIN(1135)									if (_hx_tmp9) {
HXLINE(1136)										::kha::graphics2::truetype::StbTruetype_obj::stbtt__handle_clipped_edge(scanline,0,x4,e,x01,y0,x12,y1);
HXLINE(1137)										::kha::graphics2::truetype::StbTruetype_obj::stbtt__handle_clipped_edge(scanline,0,x4,e,x12,y1,x31,y3);
            									}
            									else {
HXLINE(1138)										bool _hx_tmp10;
HXDLIN(1138)										if ((x01 < x21)) {
HXLINE(1138)											_hx_tmp10 = (x31 > x21);
            										}
            										else {
HXLINE(1138)											_hx_tmp10 = false;
            										}
HXDLIN(1138)										if (_hx_tmp10) {
...
HXLINE(1141)											bool _hx_tmp11;
HXDLIN(1141)											if ((x31 < x21)) {
HXLINE(1141)												_hx_tmp11 = (x01 > x21);
            											}
            											else {
HXLINE(1141)												_hx_tmp11 = false;
            											}
HXDLIN(1141)											if (_hx_tmp11) {
HXLINE(1142)												::kha::graphics2::truetype::StbTruetype_obj::stbtt__handle_clipped_edge(scanline,0,x4,e,x01,y0,x21,y2);
HXLINE(1143)												::kha::graphics2::truetype::StbTruetype_obj::stbtt__handle_clipped_edge(scanline,0,x4,e,x21,y2,x31,y3);
            											}
            											else {
HXLINE(1145)												::kha::graphics2::truetype::StbTruetype_obj::stbtt__handle_clipped_edge(scanline,0,x4,e,x01,y0,x31,y3);
            											}
            										}
            									}
            								}
...
HXLINE(1159)		int scanline2Index = 0;
HXLINE(1160)		int eIndex = 0;
HXLINE(1162)		if ((result->w > 64)) {
HXLINE(1163)			::Array< Float > this1 = ::Array_obj< Float >::__new(((result->w * 2) + 1));
HXDLIN(1163)			scanline = this1;
            		}
            		else {
HXLINE(1165)			::Array< Float > this2 = ::Array_obj< Float >::__new(129);
HXDLIN(1165)			scanline = this2;
            		}
HXLINE(1158)		::Array< Float > scanline2 = scanline;
HXLINE(1168)		scanline2Index = result->w;
HXLINE(1157)		int y = off_y;
HXLINE(1171)		int _hx_tmp = (off_y + result->h);
HXDLIN(1171)		( ( ::kha::graphics2::truetype::Stbtt__edge)(_hx_array_unsafe_get(e,(eIndex + n))) )->y0 = ( (Float)((_hx_tmp + 1)) );
HXLINE(1173)		while((j < result->h)){
HXLINE(1175)			Float scan_y_top = (y + ((Float)0.0));
HXLINE(1176)			Float scan_y_bottom = (y + ((Float)1.0));
HXLINE(1177)			 ::kha::graphics2::truetype::Stbtt__active_edge step_value = active;
HXDLIN(1177)			 ::Dynamic step_parent = null();
HXLINE(1179)			{
HXLINE(1179)				int _g = 0;
HXDLIN(1179)				int _g1 = result->w;
HXDLIN(1179)				while((_g < _g1)){
HXLINE(1179)					_g = (_g + 1);
HXDLIN(1179)					int i = (_g - 1);
HXDLIN(1179)					scanline->__unsafe_set(i,0);
            				}
            			}
HXLINE(1180)			{
HXLINE(1180)				int _g2 = 0;
HXDLIN(1180)				int _g3 = (result->w + 1);
HXDLIN(1180)				while((_g2 < _g3)){
HXLINE(1180)					_g2 = (_g2 + 1);
HXDLIN(1180)					int i1 = (_g2 - 1);
HXDLIN(1180)					scanline2->__unsafe_set((scanline2Index + i1),0);
            				}
            			}
...
HXLINE(1197)					if ((z->direction == 0)) {
HXLINE(1197)						HX_STACK_DO_THROW(HX_("Error",a8,3b,57,06));
            					}
HXLINE(1198)					z->direction = ( (Float)(0) );
            				}
            				else {
...
HXLINE(1215)				eIndex = (eIndex + 1);
            			}
HXLINE(1219)			if (hx::IsNotNull( active )) {
HXLINE(1220)				::kha::graphics2::truetype::StbTruetype_obj::stbtt__fill_active_edges_new(scanline,scanline2,(scanline2Index + 1),result->w,active,scan_y_top);
            			}
HXLINE(1222)			{
HXLINE(1223)				Float sum = ( (Float)(0) );
HXLINE(1224)				{
HXLINE(1224)					int _g4 = 0;
HXDLIN(1224)					int _g5 = result->w;
HXDLIN(1224)					while((_g4 < _g5)){
HXLINE(1224)						_g4 = (_g4 + 1);
HXDLIN(1224)						int i2 = (_g4 - 1);
HXLINE(1227)						sum = (sum + ( (Float)(_hx_array_unsafe_get(scanline2,(scanline2Index + i2))) ));
HXLINE(1225)						Float k = (( (Float)(_hx_array_unsafe_get(scanline,i2)) ) + sum);
HXLINE(1229)						k = ((::Math_obj::abs(k) * ((Float)255.0)) + ((Float)0.5));
HXLINE(1226)						int m = ::Std_obj::_hx_int(k);
HXLINE(1231)						if ((m > 255)) {
HXLINE(1231)							m = 255;
            						}
HXLINE(1232)						result->pixels->writeU8(((result->pixels_offset + (j * result->stride)) + i2),m);
            					}
            				}
            			}
...
HXDLIN(1254)		int j;
HXLINE(1255)		{
HXLINE(1255)			int _g = 1;
HXDLIN(1255)			int _g1 = n;
HXDLIN(1255)			while((_g < _g1)){
HXLINE(1255)				_g = (_g + 1);
HXDLIN(1255)				int i1 = (_g - 1);
...
HXLINE(1258)				j = i1;
HXLINE(1259)				while((j > 0)){
HXLINE(1260)					 ::kha::graphics2::truetype::Stbtt__edge b = ( ( ::kha::graphics2::truetype::Stbtt__edge)(_hx_array_unsafe_get(p,(j - 1))) );
HXLINE(1261)					bool c = ::kha::graphics2::truetype::StbTruetype_obj::STBTT__COMPARE(a,b);
HXLINE(1262)					if (!(c)) {
HXLINE(1262)						goto _hx_goto_66;
            					}
HXLINE(1263)					{
HXLINE(1263)						 ::kha::graphics2::truetype::Stbtt__edge val = ( ( ::kha::graphics2::truetype::Stbtt__edge)(_hx_array_unsafe_get(p,(j - 1))) );
...
HXDLIN(1273)		while((n > 12)){
HXLINE(1274)			 ::kha::graphics2::truetype::Stbtt__edge t;
HXLINE(1275)			bool c;
HXLINE(1276)			int m = (n >> 1);
HXLINE(1280)			 ::kha::graphics2::truetype::Stbtt__edge c01 = ( ( ::kha::graphics2::truetype::Stbtt__edge)(_hx_array_unsafe_get(p,pIndex)) );
HXLINE(1275)			bool c011 = ::kha::graphics2::truetype::StbTruetype_obj::STBTT__COMPARE(c01,( ( ::kha::graphics2::truetype::Stbtt__edge)(_hx_array_unsafe_get(p,(pIndex + m))) ));
HXLINE(1281)			 ::kha::graphics2::truetype::Stbtt__edge c12 = ( ( ::kha::graphics2::truetype::Stbtt__edge)(_hx_array_unsafe_get(p,(pIndex + m))) );
HXLINE(1275)			bool c121 = ::kha::graphics2::truetype::StbTruetype_obj::STBTT__COMPARE(c12,( ( ::kha::graphics2::truetype::Stbtt__edge)(_hx_array_unsafe_get(p,((pIndex + n) - 1))) ));
HXLINE(1283)			if ((c011 != c121)) {
HXLINE(1285)				int z;
HXLINE(1286)				 ::kha::graphics2::truetype::Stbtt__edge c1 = ( ( ::kha::graphics2::truetype::Stbtt__edge)(_hx_array_unsafe_get(p,pIndex)) );
HXDLIN(1286)				c = ::kha::graphics2::truetype::StbTruetype_obj::STBTT__COMPARE(c1,( ( ::kha::graphics2::truetype::Stbtt__edge)(_hx_array_unsafe_get(p,((pIndex + n) - 1))) ));
HXLINE(1289)				if ((c == c121)) {
HXLINE(1289)					z = 0;
            				}
            				else {
HXLINE(1289)					z = (n - 1);
...
HXLINE(1336)		::kha::graphics2::truetype::StbTruetype_obj::stbtt__sort_edges_quicksort(p,0,n);
...
HXDLIN(1343)		int j;
HXDLIN(1343)		int k;
HXLINE(1344)		int vsubsample = 1;
HXLINE(1345)		int ptsIndex = 0;
HXLINE(1343)		int n = 0;
HXLINE(1351)		{
HXLINE(1351)			int _g = 0;
HXDLIN(1351)			int _g1 = windings;
HXDLIN(1351)			while((_g < _g1)){
HXLINE(1351)				_g = (_g + 1);
HXDLIN(1351)				int i1 = (_g - 1);
HXLINE(1352)				n = (n + ( (int)(_hx_array_unsafe_get(wcount,i1)) ));
            			}
            		}
HXLINE(1354)		::Array< ::Dynamic> this1 = ::Array_obj< ::Dynamic>::__new((n + 1));
HXLINE(1342)		::Array< ::Dynamic> e = this1;
HXLINE(1355)		if (hx::IsNull( e )) {
HXLINE(1355)			return;
            		}
            		else {
HXLINE(1357)			int _g2 = 0;
HXDLIN(1357)			int _g3 = e->length;
HXDLIN(1357)			while((_g2 < _g3)){
HXLINE(1357)				_g2 = (_g2 + 1);
HXDLIN(1357)				int i2 = (_g2 - 1);
HXLINE(1358)				{
...
HXLINE(1343)		int m = 0;
HXLINE(1364)		{
HXLINE(1364)			int _g21 = 0;
HXDLIN(1364)			int _g31 = windings;
HXDLIN(1364)			while((_g21 < _g31)){
HXLINE(1364)				_g21 = (_g21 + 1);
HXDLIN(1364)				int i3 = (_g21 - 1);
HXLINE(1365)				::Array< ::Dynamic> p = pts;
HXLINE(1366)				int pIndex = (ptsIndex + m);
HXLINE(1367)				m = (m + ( (int)(_hx_array_unsafe_get(wcount,i3)) ));
HXLINE(1368)				j = (( (int)(_hx_array_unsafe_get(wcount,i3)) ) - 1);
HXLINE(1369)				{
HXLINE(1369)					int _g22 = 0;
HXDLIN(1369)					int _g32 = ( (int)(_hx_array_unsafe_get(wcount,i3)) );
HXDLIN(1369)					while((_g22 < _g32)){
HXLINE(1369)						_g22 = (_g22 + 1);
HXDLIN(1369)						int k1 = (_g22 - 1);
...
HXDLIN(1383)						( ( ::kha::graphics2::truetype::Stbtt__edge)(_hx_array_unsafe_get(e,n)) )->y0 = (_hx_tmp5 * ( (Float)(vsubsample) ));
...
HXDLIN(1385)						( ( ::kha::graphics2::truetype::Stbtt__edge)(_hx_array_unsafe_get(e,n)) )->y1 = (_hx_tmp7 * ( (Float)(vsubsample) ));
HXLINE(1386)						n = (n + 1);
HXLINE(1387)						j = k1;
            					}
            				}
...
HXLINE(1408)		Float mx = (((x0 + (( (Float)(2) ) * x1)) + x2) / ( (Float)(4) ));
HXLINE(1409)		Float my = (((y0 + (( (Float)(2) ) * y1)) + y2) / ( (Float)(4) ));
HXLINE(1411)		Float dx = (((x0 + x2) / ( (Float)(2) )) - mx);
HXLINE(1412)		Float dy = (((y0 + y2) / ( (Float)(2) )) - my);
HXLINE(1413)		if ((n > 16)) {
HXLINE(1414)			return 1;
            		}
HXLINE(1415)		if ((((dx * dx) + (dy * dy)) > objspace_flatness_squared)) {
HXLINE(1416)			::kha::graphics2::truetype::StbTruetype_obj::stbtt__tesselate_curve(points,num_points,x0,y0,((x0 + x1) / ((Float)2.0)),((y0 + y1) / ((Float)2.0)),mx,my,objspace_flatness_squared,(n + 1));
HXLINE(1417)			::kha::graphics2::truetype::StbTruetype_obj::stbtt__tesselate_curve(points,num_points,mx,my,((x1 + x2) / ((Float)2.0)),((y1 + y2) / ((Float)2.0)),x2,y2,objspace_flatness_squared,(n + 1));
            		}
            		else {
...
HXLINE(1420)			num_points->__SetField(HX_("value",71,7f,b8,31),(num_points->__Field(HX_("value",71,7f,b8,31),hx::paccDynamic) + 1),hx::paccDynamic);
            		}
...
HXLINE(1428)		int num_points = 0;
HXLINE(1430)		Float objspace_flatness_squared = (objspace_flatness * objspace_flatness);
HXLINE(1431)		int i;
HXDLIN(1431)		int n = 0;
HXDLIN(1431)		int start = 0;
HXDLIN(1431)		int pass;
HXLINE(1434)		{
HXLINE(1434)			int _g = 0;
HXDLIN(1434)			int _g1 = num_verts;
HXDLIN(1434)			while((_g < _g1)){
HXLINE(1434)				_g = (_g + 1);
HXDLIN(1434)				int i1 = (_g - 1);
HXLINE(1435)				if ((( ( ::kha::graphics2::truetype::Stbtt_vertex)(_hx_array_unsafe_get(vertices,i1)) )->type == 1)) {
HXLINE(1436)					n = (n + 1);
            				}
            			}
            		}
...
HXLINE(1444)			num_contours->__SetField(HX_("value",71,7f,b8,31),0,hx::paccDynamic);
HXLINE(1445)			return null();
            		}
HXLINE(1449)		{
HXLINE(1449)			int _g2 = 0;
HXDLIN(1449)			while((_g2 < 2)){
HXLINE(1449)				_g2 = (_g2 + 1);
HXDLIN(1449)				int pass1 = (_g2 - 1);
HXLINE(1450)				Float x = ( (Float)(0) );
HXDLIN(1450)				Float y = ( (Float)(0) );
HXLINE(1451)				if ((pass1 == 1)) {
...
HXLINE(1455)						num_contours->__SetField(HX_("value",71,7f,b8,31),0,hx::paccDynamic);
HXLINE(1456)						return null();
            					}
            					else {
HXLINE(1459)						int _g21 = 0;
HXDLIN(1459)						int _g3 = points->length;
HXDLIN(1459)						while((_g21 < _g3)){
HXLINE(1459)							_g21 = (_g21 + 1);
HXDLIN(1459)							int i2 = (_g21 - 1);
HXLINE(1460)							{
...
HXLINE(1464)				num_points = 0;
HXLINE(1465)				n = -1;
HXLINE(1466)				{
HXLINE(1466)					int _g22 = 0;
HXDLIN(1466)					int _g31 = num_verts;
HXDLIN(1466)					while((_g22 < _g31)){
HXLINE(1466)						_g22 = (_g22 + 1);
HXDLIN(1466)						int i3 = (_g22 - 1);
HXLINE(1467)						switch((int)(( ( ::kha::graphics2::truetype::Stbtt_vertex)(_hx_array_unsafe_get(vertices,i3)) )->type)){
            							case (int)1: {
HXLINE(1470)								if ((n >= 0)) {
...
HXDLIN(1476)								::kha::graphics2::truetype::StbTruetype_obj::stbtt__add_point(points,(num_points - 1),x,y);
            							...
            							break;
            							case (int)2: {
HXLINE(1478)								x = ( (Float)(( ( ::kha::graphics2::truetype::Stbtt_vertex)(_hx_array_unsafe_get(vertices,i3)) )->x) );
HXDLIN(1478)								y = ( (Float)(( ( ::kha::graphics2::truetype::Stbtt_vertex)(_hx_array_unsafe_get(vertices,i3)) )->y) );
HXLINE(1479)								num_points = (num_points + 1);
HXDLIN(1479)								::kha::graphics2::truetype::StbTruetype_obj::stbtt__add_point(points,(num_points - 1),x,y);
            							}
            							break;
            							case (int)3: {
...
HXLINE(1482)								::kha::graphics2::truetype::StbTruetype_obj::stbtt__tesselate_curve(points,num_points_reference,x,y,( (Float)(_hx_tmp) ),( (Float)(_hx_tmp1) ),( (Float)(_hx_tmp2) ),( (Float)(( ( ::kha::graphics2::truetype::Stbtt_vertex)(_hx_array_unsafe_get(vertices,i3)) )->y) ),objspace_flatness_squared,0);
HXLINE(1486)								num_points = ( (int)(num_points_reference->__Field(HX_("value",71,7f,b8,31),hx::paccDynamic)) );
HXLINE(1487)								x = ( (Float)(( ( ::kha::graphics2::truetype::Stbtt_vertex)(_hx_array_unsafe_get(vertices,i3)) )->x) );
HXDLIN(1487)								y = ( (Float)(( ( ::kha::graphics2::truetype::Stbtt_vertex)(_hx_array_unsafe_get(vertices,i3)) )->y) );
            							}
            							break;
            						}
            					}
...
HXLINE(1498)		int winding_count = 0;
...
HXLINE(1502)		::Array< ::Dynamic> windings = ::kha::graphics2::truetype::StbTruetype_obj::stbtt_FlattenCurves(vertices,num_verts,(flatness_in_pixels / scale),winding_lengths_reference,winding_count_reference);
...
HXLINE(1516)		if ((scale_x == 0)) {
HXLINE(1516)			scale_x = scale_y;
            		}
HXLINE(1517)		if ((scale_y == 0)) {
HXLINE(1518)			if ((scale_x == 0)) {
...
HXLINE(1511)		int ix0 = rect->x0;
HXDLIN(1511)		int iy0 = rect->y0;
HXDLIN(1511)		int ix1 = rect->x1;
HXDLIN(1511)		int iy1 = rect->y1;
...
HXDLIN(1538)		if ((gbm->w != 0)) {
HXLINE(1538)			_hx_tmp = (gbm->h != 0);
            		}
            		else {
...
HXLINE(1554)		int ix0 = 0;
HXDLIN(1554)		int iy0 = 0;
...
HXDLIN(1568)		if ((gbm->w != 0)) {
HXLINE(1568)			_hx_tmp = (gbm->h != 0);
            		}
            		else {
...
HXLINE(1608)		{
HXLINE(1608)			int _g = 0;
HXDLIN(1608)			int _g1 = (pw * ph);
HXDLIN(1608)			while((_g < _g1)){
HXLINE(1608)				_g = (_g + 1);
HXDLIN(1608)				int i = (_g - 1);
HXLINE(1609)				pixels->writeU8(i,0);
            			}
            		}
HXLINE(1604)		int y = 1;
HXDLIN(1604)		int x = y;
HXDLIN(1604)		int bottom_y = 1;
HXLINE(1603)		Float scale = ::kha::graphics2::truetype::StbTruetype_obj::stbtt_ScaleForPixelHeight(f,pixel_height);
HXLINE(1615)		int i1 = 0;
HXLINE(1616)		{
HXLINE(1616)			int _g2 = 0;
HXDLIN(1616)			while((_g2 < chars->length)){
HXLINE(1616)				int index = chars->__get(_g2);
HXDLIN(1616)				_g2 = (_g2 + 1);
...
HXLINE(1617)				int advance = metrics->advanceWidth;
HXDLIN(1617)				int lsb = metrics->leftSideBearing;
...
HXLINE(1617)				int x0 = rect->x0;
HXDLIN(1617)				int y0 = rect->y0;
HXDLIN(1617)				int x1 = rect->x1;
HXDLIN(1617)				int y1 = rect->y1;
HXDLIN(1617)				int gw = (x1 - x0);
HXDLIN(1617)				int gh = (y1 - y0);
HXLINE(1629)				if ((((x + gw) + 1) >= pw)) {
HXLINE(1630)					y = bottom_y;
HXDLIN(1630)					x = 1;
            				}
HXLINE(1632)				if ((((y + gh) + 1) >= ph)) {
...
HXLINE(1641)				( ( ::kha::graphics2::truetype::Stbtt_bakedchar)(_hx_array_unsafe_get(chardata,i1)) )->xadvance = (scale * ( (Float)(advance) ));
HXLINE(1642)				( ( ::kha::graphics2::truetype::Stbtt_bakedchar)(_hx_array_unsafe_get(chardata,i1)) )->xoff = ( (Float)(x0) );
HXLINE(1643)				( ( ::kha::graphics2::truetype::Stbtt_bakedchar)(_hx_array_unsafe_get(chardata,i1)) )->yoff = ( (Float)(y0) );
HXLINE(1644)				x = ((x + gw) + 1);
HXLINE(1645)				if ((((y + gh) + 1) > bottom_y)) {
HXLINE(1646)					bottom_y = ((y + gh) + 1);
            				}
HXLINE(1647)				i1 = (i1 + 1);
            			}
            		}
...
HXLINE(1653)			d3d_bias = ( (Float)(0) );
            		}
            		else {
HXLINE(1653)			d3d_bias = ((Float)-0.5);
            		}
HXLINE(1654)		Float ipw = (((Float)1.0) / ( (Float)(pw) ));
HXDLIN(1654)		Float iph = (((Float)1.0) / ( (Float)(ph) ));
...
HXLINE(1664)		q->s0 = (( (Float)(b->x0) ) * ipw);
HXLINE(1665)		q->t0 = (( (Float)(b->y0) ) * iph);
HXLINE(1666)		q->s1 = (( (Float)(b->x1) ) * ipw);
HXLINE(1667)		q->t1 = (( (Float)(b->y1) ) * iph);
HXLINE(1669)		 ::Dynamic xpos1 = xpos;
HXDLIN(1669)		xpos1->__SetField(HX_("value",71,7f,b8,31),(xpos1->__Field(HX_("value",71,7f,b8,31),hx::paccDynamic) + b->xadvance),hx::paccDynamic);
            	}
