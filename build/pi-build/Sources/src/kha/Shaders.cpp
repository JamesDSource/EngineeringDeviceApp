...
HXLINE( 167)							{
HXLINE( 146)								{
HXLINE( 147)									::Array< ::Dynamic> blobs = ::Array_obj< ::Dynamic>::__new();
HXLINE( 148)									{
HXLINE( 149)										::String data = ( (::String)(::Reflect_obj::field(hx::ClassOf< ::kha::Shaders >(),(HX_("painter_colored_vertData",8c,a0,fc,4b) + 0))) );
HXLINE( 150)										 ::haxe::io::Bytes bytes = ( ( ::haxe::io::Bytes)(::haxe::Unserializer_obj::run(data)) );
HXLINE( 151)										blobs->push(::kha::internal::BytesBlob_obj::fromBytes(bytes));
            									}
HXLINE( 153)									::kha::Shaders_obj::painter_colored_vert =  ::kha::graphics4::VertexShader_obj::__alloc( HX_CTX ,blobs,::Array_obj< ::String >::fromData( _hx_array_data_5c987b44_1,1));
            								}
HXLINE( 169)								{
HXLINE( 170)									::Array< ::Dynamic> blobs1 = ::Array_obj< ::Dynamic>::__new();
HXLINE( 171)									{
HXLINE( 172)										::String data1 = ( (::String)(::Reflect_obj::field(hx::ClassOf< ::kha::Shaders >(),(HX_("painter_colored_fragData",8d,d9,25,8d) + 0))) );
...
HXLINE( 176)									::kha::Shaders_obj::painter_colored_frag =  ::kha::graphics4::FragmentShader_obj::__alloc( HX_CTX ,blobs1,::Array_obj< ::String >::fromData( _hx_array_data_5c987b44_2,1));
            								}
            							}
HXLINE( 146)							{
HXLINE( 147)								::Array< ::Dynamic> blobs2 = ::Array_obj< ::Dynamic>::__new();
HXLINE( 148)								{
HXLINE( 149)									::String data2 = ( (::String)(::Reflect_obj::field(hx::ClassOf< ::kha::Shaders >(),(HX_("painter_image_vertData",93,41,0e,a1) + 0))) );
...
HXLINE( 153)								::kha::Shaders_obj::painter_image_vert =  ::kha::graphics4::VertexShader_obj::__alloc( HX_CTX ,blobs2,::Array_obj< ::String >::fromData( _hx_array_data_5c987b44_3,1));
            							}
            						}
HXLINE( 146)						{
HXLINE( 147)							::Array< ::Dynamic> blobs3 = ::Array_obj< ::Dynamic>::__new();
HXLINE( 148)							{
HXLINE( 149)								::String data3 = ( (::String)(::Reflect_obj::field(hx::ClassOf< ::kha::Shaders >(),(HX_("painter_text_vertData",99,b1,3c,b2) + 0))) );
...
HXLINE( 153)							::kha::Shaders_obj::painter_text_vert =  ::kha::graphics4::VertexShader_obj::__alloc( HX_CTX ,blobs3,::Array_obj< ::String >::fromData( _hx_array_data_5c987b44_4,1));
            						}
            					}
HXLINE( 169)					{
HXLINE( 170)						::Array< ::Dynamic> blobs4 = ::Array_obj< ::Dynamic>::__new();
HXLINE( 171)						{
HXLINE( 172)							::String data4 = ( (::String)(::Reflect_obj::field(hx::ClassOf< ::kha::Shaders >(),(HX_("painter_image_fragData",94,7a,37,e2) + 0))) );
...
HXLINE( 176)						::kha::Shaders_obj::painter_image_frag =  ::kha::graphics4::FragmentShader_obj::__alloc( HX_CTX ,blobs4,::Array_obj< ::String >::fromData( _hx_array_data_5c987b44_5,1));
            					}
            				}
HXLINE( 169)				{
HXLINE( 170)					::Array< ::Dynamic> blobs5 = ::Array_obj< ::Dynamic>::__new();
HXLINE( 171)					{
HXLINE( 172)						::String data5 = ( (::String)(::Reflect_obj::field(hx::ClassOf< ::kha::Shaders >(),(HX_("painter_text_fragData",9a,ea,65,f3) + 0))) );
...
HXLINE( 176)					::kha::Shaders_obj::painter_text_frag =  ::kha::graphics4::FragmentShader_obj::__alloc( HX_CTX ,blobs5,::Array_obj< ::String >::fromData( _hx_array_data_5c987b44_6,1));
            				}
            			}
HXLINE( 169)			{
...
HXDLIN(  37)		painter_colored_vertData0 = HX_("s350:",a7,d3,6c,e6);
            	}
{
...
{
            	HX_STACKFRAME(&_hx_pos_6dc83ef3f0d80db1_37_boot)
HXDLIN(  37)		painter_colored_fragData0 = HX_("s212:I3ZlcnNpb24gMTAwDQpwcmVjaXNpb24gbWVkaXVtcCBmbG9hdDsNCnByZWNpc2lvbiBoaWdocCBpbnQ7DQoNCnZhcnlpbmcgaGlnaHAgdmVjNCBmcmFnbWVudENvbG9yOw0KDQp2b2lkIG1haW4oKQ0Kew0KICAgIGdsX0ZyYWdEYXRhWzBdID0gZnJhZ21lbnRDb2xvcjsNCn0NCg0K",c1,4e,6f,94);
            	}
{
...
{
            	HX_STACKFRAME(&_hx_pos_6dc83ef3f0d80db1_37_boot)
HXDLIN(  37)		painter_image_vertData0 = HX_("s438:",e2,fc,26,ee);
            	}
{
            	HX_STACKFRAME(&_hx_pos_6dc83ef3f0d80db1_140_boot)
...
{
            	HX_STACKFRAME(&_hx_pos_6dc83ef3f0d80db1_37_boot)
HXDLIN(  37)		painter_text_vertData0 = HX_("s459:",93,4a,09,61);
            	}
{
            	HX_STACKFRAME(&_hx_pos_6dc83ef3f0d80db1_140_boot)
...
{
            	HX_STACKFRAME(&_hx_pos_6dc83ef3f0d80db1_37_boot)
HXDLIN(  37)		painter_image_fragData0 = HX_("s494:",1f,24,ec,f1);
            	}
{
            	HX_STACKFRAME(&_hx_pos_6dc83ef3f0d80db1_163_boot)
...
{
            	HX_STACKFRAME(&_hx_pos_6dc83ef3f0d80db1_37_boot)
HXDLIN(  37)		painter_text_fragData0 = HX_("s370:",77,3d,a2,5e);
            	}
{
            	HX_STACKFRAME(&_hx_pos_6dc83ef3f0d80db1_163_boot)
...
{
            	HX_STACKFRAME(&_hx_pos_6dc83ef3f0d80db1_37_boot)
HXDLIN(  37)		painter_video_fragData0 = HX_("s494:",1f,24,ec,f1);
            	}
{
            	HX_STACKFRAME(&_hx_pos_6dc83ef3f0d80db1_163_boot)
...
{
            	HX_STACKFRAME(&_hx_pos_6dc83ef3f0d80db1_37_boot)
HXDLIN(  37)		painter_video_vertData0 = HX_("s438:",e2,fc,26,ee);
            	}
{
            	HX_STACKFRAME(&_hx_pos_6dc83ef3f0d80db1_140_boot)
