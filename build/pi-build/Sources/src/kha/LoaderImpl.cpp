...
HXDLIN(  15)		done( ::kha::kore::Sound_obj::__alloc( HX_CTX ,( (::String)( ::Dynamic(desc->__Field(HX_("files",77,de,98,00),hx::paccDynamic))->__GetItem(0)) )));
            	}
...
HXLINE(  24)		done(::kha::Image_obj::fromFile(( (::String)( ::Dynamic(desc->__Field(HX_("files",77,de,98,00),hx::paccDynamic))->__GetItem(0)) ),readable));
            	}
...
HXDLIN(  32)		done( ::kha::internal::BytesBlob_obj::__alloc( HX_CTX ,::sys::io::File_obj::getBytes(( (::String)( ::Dynamic(desc->__Field(HX_("files",77,de,98,00),hx::paccDynamic))->__GetItem(0)) ))));
            	}
...
HXDLIN(  42)		done( ::kha::kore::Video_obj::__alloc( HX_CTX ,( (::String)( ::Dynamic(desc->__Field(HX_("files",77,de,98,00),hx::paccDynamic))->__GetItem(0)) )));
            	}
