...
HXLINE(  11)		this->framebuffer = null();
HXLINE(  10)		this->window = null();
HXLINE(   9)		this->height = -1;
HXLINE(   8)		this->width = -1;
HXLINE(   7)		this->title = HX_("Kha",04,44,39,00);
HXLINE(  23)		this->title = title;
HXLINE(  24)		 ::kha::WindowOptions _hx_tmp;
HXDLIN(  24)		if (hx::IsNull( window )) {
HXLINE(  24)			_hx_tmp =  ::kha::WindowOptions_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null(),null());
            		}
            		else {
HXLINE(  24)			_hx_tmp = window;
            		}
HXDLIN(  24)		this->window = _hx_tmp;
...
HXLINE(  43)			this->window->title = title;
            		}
HXLINE(  46)		 ::kha::FramebufferOptions _hx_tmp1;
HXDLIN(  46)		if (hx::IsNull( framebuffer )) {
HXLINE(  46)			_hx_tmp1 =  ::kha::FramebufferOptions_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
            		}
            		else {
HXLINE(  46)			_hx_tmp1 = framebuffer;
            		}
HXDLIN(  46)		this->framebuffer = _hx_tmp1;
            	}
...
bool SystemOptions_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x2fed31ab;
}
...
hx::Val SystemOptions_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		if (HX_FIELD_EQ(inName,"window") ) { window=inValue.Cast<  ::kha::WindowOptions >(); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"framebuffer") ) { framebuffer=inValue.Cast<  ::kha::FramebufferOptions >(); return inValue; }
	}
