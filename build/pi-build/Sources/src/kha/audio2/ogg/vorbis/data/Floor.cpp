...
HXDLIN(  62)							this10->__unsafe_set(j2,val4);
            						}
...
HXLINE(  70)					{
HXLINE(  70)						int _g22 = 0;
HXDLIN(  70)						int _g31 = kl;
HXDLIN(  70)						while((_g22 < _g31)){
HXLINE(  70)							_g22 = (_g22 + 1);
HXDLIN(  70)							int k = (_g22 - 1);
HXLINE(  71)							{
HXLINE(  71)								::Array< int > this13 = ( (::Array< int >)(_hx_array_unsafe_get(g1->subclassBooks,j2)) );
HXDLIN(  71)								int val5 = (decodeState->readBits(8) - 1);
HXDLIN(  71)								this13->__unsafe_set(k,val5);
            							}
...
HXLINE(  80)			::Array< int > this14 = ::Array_obj< int >::__new(250);
...
HXLINE(  84)			{
HXLINE(  84)				int _g4 = 0;
HXDLIN(  84)				int _g5 = g1->partitions;
HXDLIN(  84)				while((_g4 < _g5)){
HXLINE(  84)					_g4 = (_g4 + 1);
HXDLIN(  84)					int j3 = (_g4 - 1);
HXLINE(  85)					int c = ( (int)(_hx_array_unsafe_get(g1->partitionClassList,j3)) );
HXLINE(  86)					{
HXLINE(  86)						int _g41 = 0;
HXDLIN(  86)						int _g51 = ( (int)(_hx_array_unsafe_get(g1->classDimensions,c)) );
HXDLIN(  86)						while((_g41 < _g51)){
HXLINE(  86)							_g41 = (_g41 + 1);
HXDLIN(  86)							int k1 = (_g41 - 1);
HXLINE(  87)							{
HXLINE(  87)								::Array< int > this15 = g1->xlist;
HXDLIN(  87)								int index = g1->values;
HXDLIN(  87)								int val6 = decodeState->readBits(g1->rangebits);
HXDLIN(  87)								this15->__unsafe_set(index,val6);
            							}
HXLINE(  88)							g1->values++;
            						}
            					}
...
HXLINE(  93)			{
HXLINE(  93)				int _g6 = 0;
HXDLIN(  93)				int _g7 = g1->values;
HXDLIN(  93)				while((_g6 < _g7)){
HXLINE(  93)					_g6 = (_g6 + 1);
HXDLIN(  93)					int j4 = (_g6 - 1);
...
HXDLIN( 102)				int _g9 = g1->values;
HXDLIN( 102)				while((_g8 < _g9)){
HXLINE( 102)					_g8 = (_g8 + 1);
HXDLIN( 102)					int j5 = (_g8 - 1);
