...
HXLINE( 125)			header1->vendor = packetInput->readString(vendorLength,null());
...
HXDLIN( 157)			int _g11 = codebookCount;
HXDLIN( 157)			while((_g2 < _g11)){
...
HXDLIN( 158)					this2->__unsafe_set(i1,val);
            				}
            			}
            		}
HXLINE( 162)		x13 = (decodeState->readBits(6) + 1);
HXLINE( 163)		{
HXLINE( 163)			int _g21 = 0;
HXDLIN( 163)			int _g3 = x13;
HXDLIN( 163)			while((_g21 < _g3)){
HXLINE( 163)				_g21 = (_g21 + 1);
HXDLIN( 163)				int i2 = (_g21 - 1);
...
HXLINE( 171)		::Array< ::Dynamic> this3 = ::Array_obj< ::Dynamic>::__new(floorCount);
HXDLIN( 171)		header1->floorConfig = this3;
HXLINE( 172)		{
HXLINE( 172)			int _g4 = 0;
HXDLIN( 172)			int _g5 = floorCount;
HXDLIN( 172)			while((_g4 < _g5)){
HXLINE( 172)				_g4 = (_g4 + 1);
HXDLIN( 172)				int i3 = (_g4 - 1);
HXLINE( 173)				{
...
HXDLIN( 173)					this4->__unsafe_set(i3,val1);
            				}
            			}
            		}
HXLINE( 177)		int residueCount = (decodeState->readBits(6) + 1);
HXLINE( 178)		::Array< ::Dynamic> this5 = ::Array_obj< ::Dynamic>::__new(residueCount);
HXDLIN( 178)		header1->residueConfig = this5;
HXLINE( 179)		{
HXLINE( 179)			int _g6 = 0;
HXDLIN( 179)			int _g7 = residueCount;
HXDLIN( 179)			while((_g6 < _g7)){
HXLINE( 179)				_g6 = (_g6 + 1);
HXDLIN( 179)				int i4 = (_g6 - 1);
HXLINE( 180)				{
...
HXDLIN( 180)					this6->__unsafe_set(i4,val2);
            				}
            			}
            		}
HXLINE( 184)		int mappingCount = (decodeState->readBits(6) + 1);
HXLINE( 185)		::Array< ::Dynamic> this7 = ::Array_obj< ::Dynamic>::__new(mappingCount);
HXDLIN( 185)		header1->mapping = this7;
HXLINE( 186)		{
HXLINE( 186)			int _g8 = 0;
HXDLIN( 186)			int _g9 = mappingCount;
HXDLIN( 186)			while((_g8 < _g9)){
HXLINE( 186)				_g8 = (_g8 + 1);
HXDLIN( 186)				int i5 = (_g8 - 1);
...
HXLINE( 189)				{
HXLINE( 189)					int _g81 = 0;
HXDLIN( 189)					int _g91 = map->submaps;
HXDLIN( 189)					while((_g81 < _g91)){
HXLINE( 189)						_g81 = (_g81 + 1);
HXDLIN( 189)						int j = (_g81 - 1);
...
HXLINE( 200)		::Array< ::Dynamic> this8 = ::Array_obj< ::Dynamic>::__new(modeCount);
HXDLIN( 200)		header1->modes = this8;
HXLINE( 201)		{
HXLINE( 201)			int _g10 = 0;
HXDLIN( 201)			int _g111 = modeCount;
HXDLIN( 201)			while((_g10 < _g111)){
HXLINE( 201)				_g10 = (_g10 + 1);
HXDLIN( 201)				int i6 = (_g10 - 1);
