...
HXDLIN( 103)				int _g11 = segmentCount;
HXDLIN( 103)				while((_g2 < _g11)){
...
HXLINE( 110)			p->firstDecodedSample = 0;
...
HXDLIN( 530)				switch((int)(_g1->_hx_getIndex())){
            					case (int)0: {
HXLINE( 531)						bool l1 = _g1->_hx_getBool(1);
HXDLIN( 531)						int e1 = _g1->_hx_getInt(0);
HXDLIN( 531)						{
HXLINE( 532)							end = e1;
HXLINE( 533)							last = l1;
            						}
...
HXDLIN( 547)			int _g11 = 6;
HXDLIN( 547)			while((_g2 < _g11)){
...
HXLINE( 556)		this->pLast =  ::kha::audio2::ogg::vorbis::data::ProbedPage_obj::__alloc( HX_CTX );
HXLINE( 557)		this->pLast->pageStart = lastPageLoc;
HXLINE( 558)		this->pLast->pageEnd = end;
HXLINE( 559)		this->pLast->lastDecodedSample = lo;
HXLINE( 560)		this->pLast->firstDecodedSample = null();
...
HXDLIN( 662)			int _g11 = n;
HXDLIN( 662)			while((_g2 < _g11)){
...
HXDLIN( 666)			int _g12 = ( (int)(_hx_array_unsafe_get(pageHeader,26)) );
HXDLIN( 666)			while((_g3 < _g12)){
HXLINE( 666)				_g3 = (_g3 + 1);
HXDLIN( 666)				int i2 = (_g3 - 1);
...
HXDLIN( 674)		z->lastDecodedSample = (_hx_tmp5 + (( (int)(_hx_array_unsafe_get(pageHeader,9)) ) << 16));
HXLINE( 676)		if (((( (int)(_hx_array_unsafe_get(pageHeader,5)) ) & 4) != 0)) {
HXLINE( 679)			z->firstDecodedSample = null();
...
HXLINE( 693)		{
HXLINE( 693)			int _g21 = 0;
HXDLIN( 693)			int _g31 = ( (int)(_hx_array_unsafe_get(pageHeader,26)) );
HXDLIN( 693)			while((_g21 < _g31)){
HXLINE( 693)				_g21 = (_g21 + 1);
HXDLIN( 693)				int i3 = (_g21 - 1);
...
HXDLIN( 715)							::Array< int > this4 = ::Array_obj< int >::__new(len1);
HXDLIN( 715)							::Array< int > vec2 = this4;
HXDLIN( 715)							{
HXLINE( 715)								int _g4 = 0;
HXDLIN( 715)								int _g13 = len1;
HXDLIN( 715)								while((_g4 < _g13)){
HXLINE( 715)									_g4 = (_g4 + 1);
HXDLIN( 715)									int i4 = (_g4 - 1);
HXDLIN( 715)									{
...
HXDLIN( 717)						::Array< int > this5 = ::Array_obj< int >::__new(len2);
HXDLIN( 717)						::Array< int > vec3 = this5;
HXDLIN( 717)						{
HXLINE( 717)							int _g5 = 0;
HXDLIN( 717)							int _g14 = len2;
HXDLIN( 717)							while((_g5 < _g14)){
HXLINE( 717)								_g5 = (_g5 + 1);
HXDLIN( 717)								int i5 = (_g5 - 1);
HXDLIN( 717)								{
...
HXLINE( 776)		z->firstDecodedSample = (( (int)(z->lastDecodedSample) ) - samples);
...
HXLINE( 847)		this->error =  ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_STREAM_dyn(),null(),hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/VorbisDecodeState.hx",02,79,2e,1d),847,HX_("kha.audio2.ogg.vorbis.VorbisDecodeState",3c,6b,03,19),HX_("decodeScalarRaw",0e,d7,cb,48)));
