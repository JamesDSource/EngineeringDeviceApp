...
HXDLIN( 298)			int _g11 = this->sortedEntries;
HXDLIN( 298)			while((_g2 < _g11)){
...
HXDLIN( 312)			int _g12 = len1;
HXDLIN( 312)			while((_g3 < _g12)){
HXLINE( 312)				_g3 = (_g3 + 1);
HXDLIN( 312)				int i2 = (_g3 - 1);
...
HXDLIN( 388)						::Array< Float > _g11 = output;
HXDLIN( 388)						{
HXLINE( 388)							Float val2 = (( (Float)(_hx_array_unsafe_get(_g11,_g2)) ) + val1);
HXDLIN( 388)							_g11->__unsafe_set(_g2,val2);
            						}
            					}
...
HXLINE( 400)			{
HXLINE( 400)				int _g3 = 0;
HXDLIN( 400)				int _g12 = len;
HXDLIN( 400)				while((_g3 < _g12)){
HXLINE( 400)					_g3 = (_g3 + 1);
HXDLIN( 400)					int i2 = (_g3 - 1);
HXLINE( 401)					Float val3 = (( (Float)(_hx_array_unsafe_get(multiplicands,(z + i2))) ) + last1);
HXLINE( 402)					{
HXLINE( 402)						int _g4 = (offset + i2);
HXDLIN( 402)						::Array< Float > _g13 = output;
HXDLIN( 402)						{
HXLINE( 402)							Float val4 = (( (Float)(_hx_array_unsafe_get(_g13,_g4)) ) + val3);
HXDLIN( 402)							_g13->__unsafe_set(_g4,val4);
            						}
            					}
...
HXLINE( 407)			{
HXLINE( 407)				int _g5 = 0;
HXDLIN( 407)				int _g14 = len;
HXDLIN( 407)				while((_g5 < _g14)){
HXLINE( 407)					_g5 = (_g5 + 1);
HXDLIN( 407)					int i3 = (_g5 - 1);
HXLINE( 408)					{
HXLINE( 408)						int _g6 = (offset + i3);
HXDLIN( 408)						::Array< Float > _g15 = output;
HXDLIN( 408)						{
HXLINE( 408)							Float val5 = ( (Float)(_hx_array_unsafe_get(_g15,_g6)) );
HXDLIN( 408)							Float val6 = (val5 + (( (Float)(_hx_array_unsafe_get(multiplicands,(z + i3))) ) + last2));
HXDLIN( 408)							_g15->__unsafe_set(_g6,val6);
            						}
            					}
            				}
            			}
...
HXDLIN( 436)						::Array< Float > _g11 = output;
HXDLIN( 436)						{
HXLINE( 436)							Float val2 = (( (Float)(_hx_array_unsafe_get(_g11,_g2)) ) + val1);
HXDLIN( 436)							_g11->__unsafe_set(_g2,val2);
            						}
            					}
...
HXLINE( 446)		{
HXLINE( 446)			int _g3 = 0;
HXDLIN( 446)			int _g12 = len;
HXDLIN( 446)			while((_g3 < _g12)){
HXLINE( 446)				_g3 = (_g3 + 1);
HXDLIN( 446)				int i2 = (_g3 - 1);
HXLINE( 447)				Float val3 = (( (Float)(_hx_array_unsafe_get(multiplicands,(z + i2))) ) + last);
HXLINE( 448)				{
HXLINE( 448)					int _g4 = (offset + (i2 * step));
HXDLIN( 448)					::Array< Float > _g13 = output;
HXDLIN( 448)					{
HXLINE( 448)						Float val4 = (( (Float)(_hx_array_unsafe_get(_g13,_g4)) ) + val3);
HXDLIN( 448)						_g13->__unsafe_set(_g4,val4);
            					}
            				}
...
HXDLIN( 520)							::Array< Float > _g11 = ( (::Array< Float >)(_hx_array_unsafe_get(residueBuffers,cInter)) );
HXDLIN( 520)							{
HXLINE( 520)								Float val2 = (( (Float)(_hx_array_unsafe_get(_g11,_g2)) ) + val1);
HXDLIN( 520)								_g11->__unsafe_set(_g2,val2);
            							}
            						}
...
HXLINE( 529)					int _g3 = 0;
HXDLIN( 529)					int _g12 = effective;
HXDLIN( 529)					while((_g3 < _g12)){
HXLINE( 529)						_g3 = (_g3 + 1);
HXDLIN( 529)						int i2 = (_g3 - 1);
...
HXLINE( 532)						{
HXLINE( 532)							int _g4 = pInter;
HXDLIN( 532)							::Array< Float > _g13 = ( (::Array< Float >)(_hx_array_unsafe_get(residueBuffers,cInter)) );
HXDLIN( 532)							{
HXLINE( 532)								Float val4 = (( (Float)(_hx_array_unsafe_get(_g13,_g4)) ) + val3);
HXDLIN( 532)								_g13->__unsafe_set(_g4,val4);
            							}
            						}
...
HXDLIN( 543)					int _g14 = effective;
HXDLIN( 543)					while((_g5 < _g14)){
HXLINE( 543)						_g5 = (_g5 + 1);
HXDLIN( 543)						int i3 = (_g5 - 1);
HXLINE( 544)						Float val5 = (( (Float)(_hx_array_unsafe_get(multiplicands,(z + i3))) ) + last);
HXLINE( 545)						{
HXLINE( 545)							int _g6 = pInter;
HXDLIN( 545)							::Array< Float > _g15 = ( (::Array< Float >)(_hx_array_unsafe_get(residueBuffers,cInter)) );
HXDLIN( 545)							{
HXLINE( 545)								Float val6 = (( (Float)(_hx_array_unsafe_get(_g15,_g6)) ) + val5);
HXDLIN( 545)								_g15->__unsafe_set(_g6,val6);
            							}
            						}
...
HXLINE( 553)					int _g7 = 0;
HXDLIN( 553)					int _g16 = effective;
HXDLIN( 553)					while((_g7 < _g16)){
HXLINE( 553)						_g7 = (_g7 + 1);
HXDLIN( 553)						int i4 = (_g7 - 1);
HXLINE( 554)						Float val7 = (( (Float)(_hx_array_unsafe_get(multiplicands,(z + i4))) ) + last);
HXLINE( 555)						{
HXLINE( 555)							int _g8 = pInter;
HXDLIN( 555)							::Array< Float > _g17 = ( (::Array< Float >)(_hx_array_unsafe_get(residueBuffers,cInter)) );
HXDLIN( 555)							{
HXLINE( 555)								Float val8 = (( (Float)(_hx_array_unsafe_get(_g17,_g8)) ) + val7);
HXDLIN( 555)								_g17->__unsafe_set(_g8,val8);
            							}
            						}
...
HXLINE(  96)			{
HXLINE(  96)				int _g3 = 0;
HXDLIN(  96)				int _g12 = c->entries;
HXDLIN(  96)				while((_g3 < _g12)){
HXLINE(  96)					_g3 = (_g3 + 1);
HXDLIN(  96)					int j1 = (_g3 - 1);
...
HXLINE( 158)			{
HXLINE( 158)				int _g4 = 0;
HXDLIN( 158)				int _g13 = c->lookupValues;
HXDLIN( 158)				while((_g4 < _g13)){
HXLINE( 158)					_g4 = (_g4 + 1);
HXDLIN( 158)					int j2 = (_g4 - 1);
...
HXLINE( 170)				{
HXLINE( 170)					int _g21 = 0;
HXDLIN( 170)					int _g31 = c->lookupValues;
HXDLIN( 170)					while((_g21 < _g31)){
HXLINE( 170)						_g21 = (_g21 + 1);
HXDLIN( 170)						int j3 = (_g21 - 1);
HXLINE( 171)						{
HXLINE( 171)							::Array< Float > this9 = c->multiplicands;
HXDLIN( 171)							Float val1 = (( (Float)(( (int)(_hx_array_unsafe_get(mults,j3)) )) ) * c->deltaValue);
HXDLIN( 171)							this9->__unsafe_set(j3,(val1 + c->minimumValue));
            						}
            					}
            				}
            			}
...
HXLINE( 177)				{
HXLINE( 177)					int _g22 = 1;
HXDLIN( 177)					int _g32 = c->lookupValues;
HXDLIN( 177)					while((_g22 < _g32)){
HXLINE( 177)						_g22 = (_g22 + 1);
HXDLIN( 177)						int j4 = (_g22 - 1);
HXLINE( 178)						{
HXLINE( 178)							::Array< Float > this10 = c->multiplicands;
HXDLIN( 178)							Float val2 = ( (Float)(_hx_array_unsafe_get(c->multiplicands,(j4 - 1))) );
HXDLIN( 178)							this10->__unsafe_set(j4,val2);
            						}
            					}
            				}
