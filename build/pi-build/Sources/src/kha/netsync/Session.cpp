...
bool Session_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x5363325a;
}
...
void Session_obj::sendControllerUpdate(int id, ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_acab1baa45b33052_121_sendControllerUpdate)
...
HXLINE( 124)				 ::haxe::io::Bytes _hx_tmp2 = ( ( ::kha::netsync::Controller)(this->controllers->get(id)) )->_inputBuffer;
HXDLIN( 124)				newBuffer1->blit(0,_hx_tmp2,0,( ( ::kha::netsync::Controller)(this->controllers->get(id)) )->_inputBufferIndex);
HXLINE( 125)				( ( ::kha::netsync::Controller)(this->controllers->get(id)) )->_inputBuffer = newBuffer1;
            			}
HXLINE( 128)			{
...
HXLINE( 129)			 ::haxe::io::Bytes _hx_tmp3 = ( ( ::kha::netsync::Controller)(this->controllers->get(id)) )->_inputBuffer;
HXDLIN( 129)			int _hx_tmp4 = (( ( ::kha::netsync::Controller)(this->controllers->get(id)) )->_inputBufferIndex + 4);
HXDLIN( 129)			_hx_tmp3->blit(_hx_tmp4,bytes,0,bytes->length);
HXLINE( 130)			 ::kha::netsync::Controller _hx_tmp5 = ( ( ::kha::netsync::Controller)(this->controllers->get(id)) );
...
HXLINE( 194)				this->localClient =  ::kha::netsync::LocalClient_obj::__alloc( HX_CTX ,index);
...
HXLINE( 300)					::haxe::Log_obj::trace((HX_("Float: ",22,bf,59,b7) + value1),hx::SourceInfo(HX_("kha/netsync/Session.hx",4a,0a,5e,65),300,HX_("kha.netsync.Session",b6,ad,47,b9),HX_("executeRPC",b0,03,7c,39)));
HXLINE( 301)					args->push(value1);
            				}
            				break;
            				case (int)73: {
HXLINE( 303)					int value2 = (((( (int)(bytes->b->__get(index)) ) | (( (int)(bytes->b->__get((index + 1))) ) << 8)) | (( (int)(bytes->b->__get((index + 2))) ) << 16)) | (( (int)(bytes->b->__get((index + 3))) ) << 24));
HXLINE( 304)					index = (index + 4);
HXLINE( 305)					::haxe::Log_obj::trace((HX_("Int: ",35,09,4e,51) + value2),hx::SourceInfo(HX_("kha/netsync/Session.hx",4a,0a,5e,65),305,HX_("kha.netsync.Session",b6,ad,47,b9),HX_("executeRPC",b0,03,7c,39)));
HXLINE( 306)					args->push(value2);
            				}
            				break;
            				case (int)83: {
...
HXDLIN( 311)						int _g5 = length;
HXDLIN( 311)						while((_g4 < _g5)){
HXLINE( 311)							_g4 = (_g4 + 1);
HXDLIN( 311)							int i2 = (_g4 - 1);
...
HXLINE( 325)			 ::Dynamic _hx_tmp3 = ::kha::netsync::SyncBuilder_obj::objects->__get(syncId);
HXDLIN( 325)			::Reflect_obj::callMethod(_hx_tmp3,::Reflect_obj::field(::kha::netsync::SyncBuilder_obj::objects->__get(syncId),(methodname + HX_("_remotely",f2,1d,5f,f3))),args);
            		}
            	}
...
void Session_obj::waitForStart( ::Dynamic callback, ::Dynamic refuseCallback, ::Dynamic errorCallback, ::Dynamic closeCallback, ::Dynamic resCallback){
            		...
            		void _hx_run(){
            			HX_STACKFRAME(&_hx_pos_acab1baa45b33052_384_waitForStart)
...
HXLINE( 384)		this->network =  ::kha::netsync::Network_obj::__alloc( HX_CTX ,this->address,this->port,errorCallback, ::Dynamic(new _hx_Closure_0(_gthis,closeCallback)));
...
hx::Val Session_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		if (HX_FIELD_EQ(inName,"network") ) { network=inValue.Cast<  ::kha::netsync::Network >(); return inValue; }
		break;
	case 8:
