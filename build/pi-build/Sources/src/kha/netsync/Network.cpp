...
void Network_obj::__construct(::String url,int port, ::Dynamic errorCallback, ::Dynamic closeCallback){
            	HX_STACKFRAME(&_hx_pos_e4808080a977b708_20_new)
HXLINE(  21)		this->url = url;
HXLINE(  22)		this->port = (port + 1);
HXLINE(  23)		this->bufferPos = 0;
HXLINE(  24)		this->buffer = ::haxe::io::Bytes_obj::alloc(256);
HXLINE(  25)		this->tempBuffer = ::haxe::io::Bytes_obj::alloc(256);
...
void Network_obj::listen( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_e4808080a977b708_47_listen)
