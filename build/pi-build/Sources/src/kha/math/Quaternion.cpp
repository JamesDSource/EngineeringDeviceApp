...
HXLINE(  45)		Float q5 = (this->get_x() * dot7);
HXDLIN(  45)		Float q6 = (this->get_y() * dot7);
HXDLIN(  45)		Float q7 = (this->get_z() * dot7);
HXDLIN(  45)		 ::kha::math::Quaternion q8 =  ::kha::math::Quaternion_obj::__alloc( HX_CTX ,q5,q6,q7,(this->get_w() * dot7));
HXDLIN(  45)		Float q21 = q->get_x();
HXDLIN(  45)		Float q22 = (q21 - q8->get_x());
HXDLIN(  45)		Float q23 = q->get_y();
HXDLIN(  45)		Float q24 = (q23 - q8->get_y());
HXDLIN(  45)		Float q25 = q->get_z();
HXDLIN(  45)		Float q26 = (q25 - q8->get_z());
HXDLIN(  45)		Float q27 = q->get_w();
HXDLIN(  45)		 ::kha::math::Quaternion q28 =  ::kha::math::Quaternion_obj::__alloc( HX_CTX ,q22,q24,q26,(q27 - q8->get_w()));
HXLINE(  46)		{
HXLINE(  46)			Float scale1 = (((Float)1.0) / q28->get_length());
HXDLIN(  46)			q28->set_x((q28->get_x() * scale1));
HXDLIN(  46)			q28->set_y((q28->get_y() * scale1));
HXDLIN(  46)			q28->set_z((q28->get_z() * scale1));
HXDLIN(  46)			q28->set_w((q28->get_w() * scale1));
            		}
HXLINE(  48)		Float scale2 = ::Math_obj::cos(theta);
HXDLIN(  48)		Float _this8 = (this->get_x() * scale2);
HXDLIN(  48)		Float _this9 = (this->get_y() * scale2);
HXDLIN(  48)		Float _this10 = (this->get_z() * scale2);
HXDLIN(  48)		 ::kha::math::Quaternion _this11 =  ::kha::math::Quaternion_obj::__alloc( HX_CTX ,_this8,_this9,_this10,(this->get_w() * scale2));
HXDLIN(  48)		Float scale3 = ::Math_obj::sin(theta);
HXDLIN(  48)		Float q9 = (q28->get_x() * scale3);
HXDLIN(  48)		Float q10 = (q28->get_y() * scale3);
HXDLIN(  48)		Float q11 = (q28->get_z() * scale3);
HXDLIN(  48)		 ::kha::math::Quaternion q12 =  ::kha::math::Quaternion_obj::__alloc( HX_CTX ,q9,q10,q11,(q28->get_w() * scale3));
HXDLIN(  48)		Float result8 = _this11->get_x();
HXDLIN(  48)		Float result9 = (result8 + q12->get_x());
HXDLIN(  48)		Float result10 = _this11->get_y();
HXDLIN(  48)		Float result11 = (result10 + q12->get_y());
HXDLIN(  48)		Float result12 = _this11->get_z();
HXDLIN(  48)		Float result13 = (result12 + q12->get_z());
HXDLIN(  48)		Float result14 = _this11->get_w();
HXDLIN(  48)		 ::kha::math::Quaternion result15 =  ::kha::math::Quaternion_obj::__alloc( HX_CTX ,result9,result11,result13,(result14 + q12->get_w()));
HXLINE(  50)		{
HXLINE(  50)			Float scale4 = (((Float)1.0) / result15->get_length());
HXDLIN(  50)			result15->set_x((result15->get_x() * scale4));
HXDLIN(  50)			result15->set_y((result15->get_y() * scale4));
HXDLIN(  50)			result15->set_z((result15->get_z() * scale4));
HXDLIN(  50)			result15->set_w((result15->get_w() * scale4));
            		}
HXLINE(  52)		return result15;
            	}
...
HXDLIN( 243)			result->z = (( (Float)((S * D)) ) * ::Math_obj::atan2((( (Float)(2) ) * (_hx_tmp1 + (_hx_tmp2 * Q->__get(A3)))),(((ww1 + Q22) - Q11) - Q33)));
            		}
            		else {
HXLINE( 245)			if ((s21 > (( (Float)(1) ) - SingularityRadius))) {
HXLINE( 246)				result->x = ( (Float)(0) );
HXLINE( 247)				result->y = (( (Float)((S * D)) ) * PiOver2);
HXLINE( 248)				Float _hx_tmp3 = ((psign * Q->__get(A1)) * Q->__get(A2));
HXDLIN( 248)				Float _hx_tmp4 = this->get_w();
HXDLIN( 248)				result->z = (( (Float)((S * D)) ) * ::Math_obj::atan2((( (Float)(2) ) * (_hx_tmp3 + (_hx_tmp4 * Q->__get(A3)))),(((ww1 + Q22) - Q11) - Q33)));
            			}
            			else {
HXLINE( 251)				Float _hx_tmp5 = this->get_w();
HXDLIN( 251)				result->x = (( (Float)((-(S) * D)) ) * ::Math_obj::atan2((( (Float)(-2) ) * ((_hx_tmp5 * Q->__get(A1)) - ((psign * Q->__get(A2)) * Q->__get(A3)))),(((ww1 + Q33) - Q11) - Q22)));
HXLINE( 252)				result->y = (( (Float)((S * D)) ) * ::Math_obj::asin(s21));
HXLINE( 253)				Float _hx_tmp6 = this->get_w();
HXDLIN( 253)				result->z = (( (Float)((S * D)) ) * ::Math_obj::atan2((( (Float)(2) ) * ((_hx_tmp6 * Q->__get(A3)) - ((psign * Q->__get(A1)) * Q->__get(A2)))),(((ww1 + Q11) - Q22) - Q33)));
            			}
            		}
